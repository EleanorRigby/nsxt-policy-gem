...
module SwaggerClient
  ...
  class ChildCommunityList
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'CommunityList')
        self.community_list = attributes[:'CommunityList']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @community_list.nil?
        invalid_properties.push('invalid value for "community_list", community_list cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @community_list.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          community_list == o.community_list
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, community_list].hash
    end
