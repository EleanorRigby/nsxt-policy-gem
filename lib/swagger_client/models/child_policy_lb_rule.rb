...
module SwaggerClient
  ...
  class ChildPolicyLbRule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyLbRule')
        self.policy_lb_rule = attributes[:'PolicyLbRule']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_lb_rule.nil?
        invalid_properties.push('invalid value for "policy_lb_rule", policy_lb_rule cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_lb_rule.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_lb_rule == o.policy_lb_rule
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_lb_rule].hash
    end
