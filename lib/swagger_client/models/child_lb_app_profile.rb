...
module SwaggerClient
  ...
  class ChildLBAppProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LBAppProfile')
        self.lb_app_profile = attributes[:'LBAppProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lb_app_profile.nil?
        invalid_properties.push('invalid value for "lb_app_profile", lb_app_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @lb_app_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          lb_app_profile == o.lb_app_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, lb_app_profile].hash
    end
