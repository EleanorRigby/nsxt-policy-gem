...
module SwaggerClient
  ...
  class ClusterNodeVMDeploymentRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'user_settings')
    ...
    def list_invalid_properties
      ...
      if @deployment_config.nil?
        invalid_properties.push('invalid value for "deployment_config", deployment_config cannot be nil.')
      end
    ...
    def valid?
      return false if @deployment_config.nil?
    ...
    def hash
      [deployment_config, vm_id, user_settings, roles, form_factor].hash
    end
