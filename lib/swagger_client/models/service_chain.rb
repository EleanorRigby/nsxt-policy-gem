...
module SwaggerClient
  ...
  class ServiceChain
    ...
    def self.swagger_types
      {
        ...
        :'reverse_path_service_profiles' => :'Array<ResourceReference>',
        :'service_attachments' => :'Array<ResourceReference>',
        :'forward_path_service_profiles' => :'Array<ResourceReference>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'service_attachments')
      ...
      if attributes.has_key?(:'service_chain_id')
    ...
    def valid?
      ...
      path_selection_policy_validator = EnumAttributeValidator.new('String', ['ANY', 'LOCAL', 'REMOTE'])
    ...
    def path_selection_policy=(path_selection_policy)
      validator = EnumAttributeValidator.new('String', ['ANY', 'LOCAL', 'REMOTE'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, reverse_path_service_profiles, service_attachments, forward_path_service_profiles, service_chain_id, path_selection_policy, on_failure_policy].hash
    end
