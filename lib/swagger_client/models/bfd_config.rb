...
module SwaggerClient
  ...
  class BfdConfig
    ...
    def list_invalid_properties
      ...
      if !@receive_interval.nil? && @receive_interval < 100
        invalid_properties.push('invalid value for "receive_interval", must be greater than or equal to 100.')
      end
      ...
      if !@transmit_interval.nil? && @transmit_interval < 100
        invalid_properties.push('invalid value for "transmit_interval", must be greater than or equal to 100.')
      end
    ...
    def valid?
      ...
      return false if !@receive_interval.nil? && @receive_interval < 100
      ...
      return false if !@transmit_interval.nil? && @transmit_interval < 100
      true
    end
    ...
    def receive_interval=(receive_interval)
      ...
      if !receive_interval.nil? && receive_interval < 100
        fail ArgumentError, 'invalid value for "receive_interval", must be greater than or equal to 100.'
      end
    ...
    def transmit_interval=(transmit_interval)
      ...
      if !transmit_interval.nil? && transmit_interval < 100
        fail ArgumentError, 'invalid value for "transmit_interval", must be greater than or equal to 100.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, receive_interval, declare_dead_multiple, enabled, logical_router_id, transmit_interval].hash
    end
