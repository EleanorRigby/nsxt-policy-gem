...
module SwaggerClient
  ...
  class ChildServiceInterface
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ServiceInterface')
        self.service_interface = attributes[:'ServiceInterface']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @service_interface.nil?
        invalid_properties.push('invalid value for "service_interface", service_interface cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @service_interface.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_interface == o.service_interface
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, service_interface].hash
    end
