...
module SwaggerClient
  ...
  class ChildPolicyEdgeCluster
    ...
    attr_accessor :policy_edge_cluster
    ...
    def self.attribute_map
      {
        ...
        :'policy_edge_cluster' => :'PolicyEdgeCluster'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyEdgeCluster')
        self.policy_edge_cluster = attributes[:'PolicyEdgeCluster']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_edge_cluster.nil?
        invalid_properties.push('invalid value for "policy_edge_cluster", policy_edge_cluster cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_edge_cluster.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_edge_cluster == o.policy_edge_cluster
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_edge_cluster].hash
    end
