...
module SwaggerClient
  ...
  class ChildVirtualEndpoint
    ...
    attr_accessor :virtual_endpoint
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VirtualEndpoint')
        self.virtual_endpoint = attributes[:'VirtualEndpoint']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @virtual_endpoint.nil?
        invalid_properties.push('invalid value for "virtual_endpoint", virtual_endpoint cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @virtual_endpoint.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          virtual_endpoint == o.virtual_endpoint
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, virtual_endpoint].hash
    end
