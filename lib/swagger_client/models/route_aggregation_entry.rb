...
module SwaggerClient
  ...
  class RouteAggregationEntry
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'summary_only')
        self.summary_only = attributes[:'summary_only']
      else
