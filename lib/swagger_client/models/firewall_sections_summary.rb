...
module SwaggerClient
  class FirewallSectionsSummary
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'section_count')
        self.section_count = attributes[:'section_count']
      end
    ...
    def valid?
      section_type_validator = EnumAttributeValidator.new('String', ['L2DFW', 'L3DFW', 'L3BRIDGEPORTFW', 'L3LOGICALROUTERFW'])
    ...
    def section_type=(section_type)
      validator = EnumAttributeValidator.new('String', ['L2DFW', 'L3DFW', 'L3BRIDGEPORTFW', 'L3LOGICALROUTERFW'])
    ...
    def hash
      [_self, _links, _schema, section_count, rule_count, section_type].hash
    end
