...
module SwaggerClient
  class MonthlyTelemetrySchedule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'frequency_type')
    ...
    def list_invalid_properties
      ...
      if @frequency_type.nil?
        invalid_properties.push('invalid value for "frequency_type", frequency_type cannot be nil.')
      end
      ...
      if @day_of_month.nil?
        invalid_properties.push('invalid value for "day_of_month", day_of_month cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @day_of_month > 31
      return false if @day_of_month < 1
    ...
    def hash
      [frequency_type, minutes, day_of_month, hour_of_day].hash
    end
