...
module SwaggerClient
  ...
  class ChildGlobalConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'GlobalConfig')
        self.global_config = attributes[:'GlobalConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @global_config.nil?
        invalid_properties.push('invalid value for "global_config", global_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @global_config.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, global_config].hash
    end
