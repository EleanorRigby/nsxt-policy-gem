...
module SwaggerClient
  ...
  class PreconfiguredHostSwitch
    ...
    def self.swagger_types
      {
        ...
        :'endpoints' => :'Array<PreconfiguredEndpoint>'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @host_switch_id.nil?
        invalid_properties.push('invalid value for "host_switch_id", host_switch_id cannot be nil.')
      end
    ...
    def valid?
      return false if @host_switch_id.nil?
      true
    end
