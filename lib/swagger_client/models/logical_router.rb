...
module SwaggerClient
  class LogicalRouter
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, edge_cluster_member_indices, failover_mode, allocation_profile, firewall_sections, advanced_config, router_type, preferred_edge_cluster_member_index, high_availability_mode, edge_cluster_id].hash
    end
