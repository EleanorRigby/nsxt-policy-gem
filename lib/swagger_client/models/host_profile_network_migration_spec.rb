...
module SwaggerClient
  ...
  class HostProfileNetworkMigrationSpec
    ...
    def self.swagger_types
      {
        ...
        :'network_mappings' => :'Array<VmkToLogicalSwitchMapping>'
      }
    end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['HostProfileNetworkMigrationSpec'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['HostProfileNetworkMigrationSpec'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, network_mappings].hash
    end
