...
module SwaggerClient
  ...
  class L2VPNService
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'enable_hub')
        self.enable_hub = attributes[:'enable_hub']
      else
        self.enable_hub = false
      end
    end
    ...
    def valid?
      ...
      mode_validator = EnumAttributeValidator.new('String', ['SERVER', 'CLIENT'])
    ...
    def mode=(mode)
      validator = EnumAttributeValidator.new('String', ['SERVER', 'CLIENT'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, mode, enable_hub].hash
    end
