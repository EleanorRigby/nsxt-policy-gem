...
module SwaggerClient
  ...
  class StaticRoutes
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'next_hops')
        if (value = attributes[:'next_hops']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @next_hops.nil?
        invalid_properties.push('invalid value for "next_hops", next_hops cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, next_hops, network].hash
    end
