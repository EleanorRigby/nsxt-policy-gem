...
module SwaggerClient
  ...
  class LBSourceIpPersistenceProfile
    ...
    attr_accessor :ha_persistence_mirroring_enabled
    ...
    def self.swagger_types
      {
        ...
        :'persistence_shared' => :'BOOLEAN',
        :'purge' => :'String',
        :'ha_persistence_mirroring_enabled' => :'BOOLEAN',
        :'timeout' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'persistence_shared')
        self.persistence_shared = attributes[:'persistence_shared']
      else
        self.persistence_shared = false
      end

      if attributes.has_key?(:'purge')
        self.purge = attributes[:'purge']
      else
        self.purge = 'FULL'
      end

      if attributes.has_key?(:'ha_persistence_mirroring_enabled')
        self.ha_persistence_mirroring_enabled = attributes[:'ha_persistence_mirroring_enabled']
      else
        self.ha_persistence_mirroring_enabled = false
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['LBSourceIpPersistenceProfile', 'LBCookiePersistenceProfile'])
      return false unless resource_type_validator.valid?(@resource_type)
      purge_validator = EnumAttributeValidator.new('String', ['NO_PURGE', 'FULL'])
      return false unless purge_validator.valid?(@purge)
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['LBSourceIpPersistenceProfile', 'LBCookiePersistenceProfile'])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] purge Object to be assigned
    def purge=(purge)
      validator = EnumAttributeValidator.new('String', ['NO_PURGE', 'FULL'])
      unless validator.valid?(purge)
        fail ArgumentError, 'invalid value for "purge", must be one of #{validator.allowable_values}.'
      end
      @purge = purge
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          purge == o.purge &&
          ha_persistence_mirroring_enabled == o.ha_persistence_mirroring_enabled &&
          timeout == o.timeout
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, persistence_shared, purge, ha_persistence_mirroring_enabled, timeout].hash
    end
