...
module SwaggerClient
  ...
  class EndpointRule
    ...
    attr_accessor :service_profiles
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'service_profiles')
        if (value = attributes[:'service_profiles']).is_a?(Array)
          self.service_profiles = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @service_profiles.nil?
        invalid_properties.push('invalid value for "service_profiles", service_profiles cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @service_profiles.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_profiles == o.service_profiles &&
          groups == o.groups &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, service_profiles, groups, sequence_number].hash
    end
