...
module SwaggerClient
  class ComputeCollection
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, origin_id, origin_properties, external_id, owner_id, origin_type, cm_local_id].hash
    end
