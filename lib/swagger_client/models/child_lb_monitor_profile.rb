...
module SwaggerClient
  ...
  class ChildLBMonitorProfile
    ...
    def self.attribute_map
      {
        ...
        :'lb_monitor_profile' => :'LBMonitorProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LBMonitorProfile')
        self.lb_monitor_profile = attributes[:'LBMonitorProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lb_monitor_profile.nil?
        invalid_properties.push('invalid value for "lb_monitor_profile", lb_monitor_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @lb_monitor_profile.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, lb_monitor_profile].hash
    end
