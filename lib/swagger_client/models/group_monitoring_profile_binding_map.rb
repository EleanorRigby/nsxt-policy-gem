...
module SwaggerClient
  ...
  class GroupMonitoringProfileBindingMap
    ...
    attr_accessor :ipfix_l2_profile_path

    # PolicyPath of associated IPFIX DFW Profile
    attr_accessor :ipfix_dfw_profile_path

    # PolicyPath of associated Port Mirroring Profile
    attr_accessor :port_mirroring_profile_path
    ...
    def self.attribute_map
      {
        ...
        :'ipfix_l2_profile_path' => :'ipfix_l2_profile_path',
        :'ipfix_dfw_profile_path' => :'ipfix_dfw_profile_path',
        :'port_mirroring_profile_path' => :'port_mirroring_profile_path'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ipfix_l2_profile_path')
        self.ipfix_l2_profile_path = attributes[:'ipfix_l2_profile_path']
      end

      if attributes.has_key?(:'ipfix_dfw_profile_path')
        self.ipfix_dfw_profile_path = attributes[:'ipfix_dfw_profile_path']
      end

      if attributes.has_key?(:'port_mirroring_profile_path')
        self.port_mirroring_profile_path = attributes[:'port_mirroring_profile_path']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ipfix_l2_profile_path == o.ipfix_l2_profile_path &&
          ipfix_dfw_profile_path == o.ipfix_dfw_profile_path &&
          port_mirroring_profile_path == o.port_mirroring_profile_path
    end
