...
module SwaggerClient
  class Notification
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'uri_filters')
        if (value = attributes[:'uri_filters']).is_a?(Array)
          self.uri_filters = value
        end
      end
    end
    ...
    def hash
      [notification_id, uri_filters].hash
    end
