...
module SwaggerClient
  class VmToolsInfo
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, source, vm_type, network_agent_version, host_local_id, external_id, tools_version, file_agent_version].hash
    end
