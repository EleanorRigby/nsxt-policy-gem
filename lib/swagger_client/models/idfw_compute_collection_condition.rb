...
module SwaggerClient
  ...
  class IdfwComputeCollectionCondition
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'UP', 'DOWN', 'DFW_DISABLED', 'IDFW_DISABLED'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'UP', 'DOWN', 'DFW_DISABLED', 'IDFW_DISABLED'])
