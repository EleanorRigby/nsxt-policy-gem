...
module SwaggerClient
  ...
  class ChildPolicyTransportZone
    ...
    attr_accessor :policy_transport_zone
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyTransportZone')
        self.policy_transport_zone = attributes[:'PolicyTransportZone']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_transport_zone.nil?
        invalid_properties.push('invalid value for "policy_transport_zone", policy_transport_zone cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_transport_zone.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_transport_zone == o.policy_transport_zone
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_transport_zone].hash
    end
