...
module SwaggerClient
  ...
  class ServiceInsertionRule
    ...
    # A rule can be redirected to ServiceInstance, InstanceEndpoint for North/South Traffic. A rule can be redirected to ServiceChain for East/West Traffic.
    attr_accessor :redirect_tos
    ...
    def self.swagger_types
      {
        ...
        :'services' => :'Array<ServiceInsertionService>',
        :'redirect_tos' => :'Array<ResourceReference>',
        :'section_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'redirect_tos')
        if (value = attributes[:'redirect_tos']).is_a?(Array)
          self.redirect_tos = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @redirect_tos.nil?
        invalid_properties.push('invalid value for "redirect_tos", redirect_tos cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @redirect_tos.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _owner, display_name, id, resource_type, description, is_default, direction, rule_tag, ip_protocol, notes, applied_tos, logged, disabled, sources, action, sources_excluded, destinations_excluded, destinations, services, redirect_tos, section_id].hash
    end
