...
module SwaggerClient
  class PnicMirrorDestination
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dest_pnics')
        if (value = attributes[:'dest_pnics']).is_a?(Array)
          self.dest_pnics = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @dest_pnics.nil?
        invalid_properties.push('invalid value for "dest_pnics", dest_pnics cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dest_pnics.nil?
    ...
    def hash
      [resource_type, dest_pnics, node_id].hash
    end
