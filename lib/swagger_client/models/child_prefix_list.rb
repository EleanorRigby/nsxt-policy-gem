...
module SwaggerClient
  ...
  class ChildPrefixList
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PrefixList')
        self.prefix_list = attributes[:'PrefixList']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @prefix_list.nil?
        invalid_properties.push('invalid value for "prefix_list", prefix_list cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @prefix_list.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, prefix_list].hash
    end
