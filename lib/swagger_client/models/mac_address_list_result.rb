...
module SwaggerClient
  class MacAddressListResult
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, last_update_timestamp, logical_switch_id, results, transport_node_id].hash
    end
