...
module SwaggerClient
  ...
  class EnforcementPoint
    ...
    def self.swagger_types
      {
        ...
        :'connection_info' => :'EnforcementPointConnectionInfo',
        :'version' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'connection_info')
      ...
      if attributes.has_key?(:'auto_enforce')
        self.auto_enforce = attributes[:'auto_enforce']
      else
        self.auto_enforce = true
      end
    end
    ...
    def list_invalid_properties
      ...
      if @connection_info.nil?
        invalid_properties.push('invalid value for "connection_info", connection_info cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @connection_info.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, connection_info, version, auto_enforce].hash
    end
