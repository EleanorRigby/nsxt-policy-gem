...
module SwaggerClient
  ...
  class ChildIPSecVpnIkeProfile
    ...
    attr_accessor :ip_sec_vpn_ike_profile
    ...
    def self.attribute_map
      {
        ...
        :'ip_sec_vpn_ike_profile' => :'IPSecVpnIkeProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IPSecVpnIkeProfile')
        self.ip_sec_vpn_ike_profile = attributes[:'IPSecVpnIkeProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ip_sec_vpn_ike_profile.nil?
        invalid_properties.push('invalid value for "ip_sec_vpn_ike_profile", ip_sec_vpn_ike_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ip_sec_vpn_ike_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ip_sec_vpn_ike_profile == o.ip_sec_vpn_ike_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, ip_sec_vpn_ike_profile].hash
    end
