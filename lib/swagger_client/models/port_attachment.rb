...
module SwaggerClient
  ...
  class PortAttachment
    ...
    def valid?
      allocate_addresses_validator = EnumAttributeValidator.new('String', ['IP_POOL', 'MAC_POOL', 'BOTH', 'NONE'])
      return false unless allocate_addresses_validator.valid?(@allocate_addresses)
      type_validator = EnumAttributeValidator.new('String', ['PARENT', 'CHILD', 'INDEPENDENT'])
    ...
    def allocate_addresses=(allocate_addresses)
      validator = EnumAttributeValidator.new('String', ['IP_POOL', 'MAC_POOL', 'BOTH', 'NONE'])
    ...
    def hash
      [traffic_tag, allocate_addresses, context_id, type, app_id, id].hash
    end
