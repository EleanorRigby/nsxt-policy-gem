...
module SwaggerClient
  class FirewallRule
    ...
    # NS Profile object which accepts attributes and sub-attributes of various network services (ex. L7 AppId, domain name, encryption algorithm) as key value pairs. For Flash release, only one context profile is supported.
    attr_accessor :context_profiles
    ...
    attr_accessor :extended_sources
    ...
    def self.swagger_types
      {
        ...
        :'context_profiles' => :'Array<ResourceReference>',
        :'extended_sources' => :'Array<ResourceReference>',
        :'section_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'context_profiles')
        if (value = attributes[:'context_profiles']).is_a?(Array)
          self.context_profiles = value
        end
      end

      if attributes.has_key?(:'extended_sources')
        if (value = attributes[:'extended_sources']).is_a?(Array)
          self.extended_sources = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          services == o.services &&
          context_profiles == o.context_profiles &&
          extended_sources == o.extended_sources &&
    ...
    def hash
      [_self, _links, _schema, _revision, _owner, display_name, id, resource_type, description, is_default, direction, rule_tag, ip_protocol, notes, applied_tos, logged, disabled, sources, action, sources_excluded, destinations_excluded, destinations, services, context_profiles, extended_sources, section_id].hash
    end
