...
module SwaggerClient
  ...
  class LBClientSslProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'prefer_server_ciphers')
    ...
    def list_invalid_properties
      ...
      if !@session_cache_timeout.nil? && @session_cache_timeout > 86400
        invalid_properties.push('invalid value for "session_cache_timeout", must be smaller than or equal to 86400.')
      end

      if !@session_cache_timeout.nil? && @session_cache_timeout < 1
        invalid_properties.push('invalid value for "session_cache_timeout", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@session_cache_timeout.nil? && @session_cache_timeout > 86400
      return false if !@session_cache_timeout.nil? && @session_cache_timeout < 1
      cipher_group_label_validator = EnumAttributeValidator.new('String', ['BALANCED', 'HIGH_SECURITY', 'HIGH_COMPATIBILITY', 'CUSTOM'])
    ...
    # Custom attribute writer method with validation
    # @param [Object] session_cache_timeout Value to be assigned
    def session_cache_timeout=(session_cache_timeout)
      if !session_cache_timeout.nil? && session_cache_timeout > 86400
        fail ArgumentError, 'invalid value for "session_cache_timeout", must be smaller than or equal to 86400.'
      end

      if !session_cache_timeout.nil? && session_cache_timeout < 1
        fail ArgumentError, 'invalid value for "session_cache_timeout", must be greater than or equal to 1.'
      end
    ...
    def cipher_group_label=(cipher_group_label)
      validator = EnumAttributeValidator.new('String', ['BALANCED', 'HIGH_SECURITY', 'HIGH_COMPATIBILITY', 'CUSTOM'])
