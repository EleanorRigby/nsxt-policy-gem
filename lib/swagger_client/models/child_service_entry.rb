...
module SwaggerClient
  ...
  class ChildServiceEntry
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ServiceEntry')
        self.service_entry = attributes[:'ServiceEntry']
      end
    ...
    def list_invalid_properties
      ...
      if @service_entry.nil?
        invalid_properties.push('invalid value for "service_entry", service_entry cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @service_entry.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, service_entry, service].hash
    end
