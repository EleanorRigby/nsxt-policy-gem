...
module SwaggerClient
  ...
  class ConditionalValueConstraintExpression
    ...
    attr_accessor :value_constraint

    # List of values.
    attr_accessor :rhs_value
    ...
    def self.swagger_types
      {
        :'operator' => :'String',
        :'value_constraint' => :'ValueConstraintExpression',
        :'rhs_value' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'value_constraint')
        self.value_constraint = attributes[:'value_constraint']
      end

      if attributes.has_key?(:'rhs_value')
        if (value = attributes[:'rhs_value']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @value_constraint.nil?
        invalid_properties.push('invalid value for "value_constraint", value_constraint cannot be nil.')
      end

      if @rhs_value.nil?
        invalid_properties.push('invalid value for "rhs_value", rhs_value cannot be nil.')
      end
    ...
    def valid?
      ...
      operator_validator = EnumAttributeValidator.new('String', ['INCLUDES', 'EXCLUDES', 'EQUALS'])
      return false unless operator_validator.valid?(@operator)
      return false if @value_constraint.nil?
      return false if @rhs_value.nil?
      true
    end
    ...
    def operator=(operator)
      validator = EnumAttributeValidator.new('String', ['INCLUDES', 'EXCLUDES', 'EQUALS'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          operator == o.operator &&
          value_constraint == o.value_constraint &&
          rhs_value == o.rhs_value
    end
    ...
    def hash
      [operator, value_constraint, rhs_value].hash
    end
