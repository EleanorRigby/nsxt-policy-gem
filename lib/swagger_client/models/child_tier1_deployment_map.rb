...
module SwaggerClient
  ...
  class ChildTier1DeploymentMap
    ...
    attr_accessor :tier1_deployment_map
    ...
    def self.attribute_map
      {
        ...
        :'tier1_deployment_map' => :'Tier1DeploymentMap'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Tier1DeploymentMap')
        self.tier1_deployment_map = attributes[:'Tier1DeploymentMap']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tier1_deployment_map.nil?
        invalid_properties.push('invalid value for "tier1_deployment_map", tier1_deployment_map cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tier1_deployment_map.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tier1_deployment_map == o.tier1_deployment_map
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, tier1_deployment_map].hash
    end
