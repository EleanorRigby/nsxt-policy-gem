...
module SwaggerClient
  ...
  class ChildSpoofGuardProfile
    ...
    attr_accessor :spoof_guard_profile
    ...
    def self.attribute_map
      {
        ...
        :'spoof_guard_profile' => :'SpoofGuardProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SpoofGuardProfile')
        self.spoof_guard_profile = attributes[:'SpoofGuardProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @spoof_guard_profile.nil?
        invalid_properties.push('invalid value for "spoof_guard_profile", spoof_guard_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @spoof_guard_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          spoof_guard_profile == o.spoof_guard_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, spoof_guard_profile].hash
    end
