...
module SwaggerClient
  ...
  class SecurityPolicyStatistics
    ...
    attr_accessor :internal_section_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'internal_section_id')
        self.internal_section_id = attributes[:'internal_section_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          internal_section_id == o.internal_section_id &&
    ...
    def hash
      [internal_section_id, result_count, results, lr_path].hash
    end
