...
module SwaggerClient
  ...
  class IdfwNsgroupVmDetailListResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ns_group_id')
        self.ns_group_id = attributes[:'ns_group_id']
      end
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, ns_group_id, results].hash
    end
