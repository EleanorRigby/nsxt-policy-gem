...
module SwaggerClient
  ...
  class PolicyServiceProfile
    ...
    attr_accessor :vendor_template_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vendor_template_name')
        self.vendor_template_name = attributes[:'vendor_template_name']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vendor_template_name.nil?
        invalid_properties.push('invalid value for "vendor_template_name", vendor_template_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vendor_template_name.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vendor_template_name == o.vendor_template_name
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, attributes, redirection_action, vendor_template_name].hash
    end
