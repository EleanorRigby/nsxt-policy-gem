...
module SwaggerClient
  ...
  class X509CrlEntry
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'revocation_date')
        self.revocation_date = attributes[:'revocation_date']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          revocation_date == o.revocation_date &&
    ...
    def hash
      [revocation_date, serial_number].hash
    end
