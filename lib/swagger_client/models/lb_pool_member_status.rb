...
module SwaggerClient
  class LbPoolMemberStatus
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['UP', 'DOWN', 'DISABLED', 'GRACEFUL_DISABLED', 'UNUSED'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['UP', 'DOWN', 'DISABLED', 'GRACEFUL_DISABLED', 'UNUSED'])
