...
module SwaggerClient
  ...
  class ChildPolicyLbPoolAccess
    ...
    attr_accessor :policy_lb_pool_access
    ...
    def self.attribute_map
      {
        ...
        :'policy_lb_pool_access' => :'PolicyLbPoolAccess'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyLbPoolAccess')
        self.policy_lb_pool_access = attributes[:'PolicyLbPoolAccess']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_lb_pool_access.nil?
        invalid_properties.push('invalid value for "policy_lb_pool_access", policy_lb_pool_access cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_lb_pool_access.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_lb_pool_access == o.policy_lb_pool_access
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_lb_pool_access].hash
    end
