...
module SwaggerClient
  ...
  class CommunityMatchExpression
    ...
    def self.swagger_types
      {
        :'operator' => :'String',
        :'expression' => :'Array<CommunityMatchOperation>'
      }
    end
    ...
    def valid?
      operator_validator = EnumAttributeValidator.new('String', ['AND'])
