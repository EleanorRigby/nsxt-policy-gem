...
module SwaggerClient
  ...
  class ChildLBClientSslProfile
    ...
    attr_accessor :lb_client_ssl_profile
    ...
    def self.attribute_map
      {
        ...
        :'lb_client_ssl_profile' => :'LBClientSslProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LBClientSslProfile')
        self.lb_client_ssl_profile = attributes[:'LBClientSslProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lb_client_ssl_profile.nil?
        invalid_properties.push('invalid value for "lb_client_ssl_profile", lb_client_ssl_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @lb_client_ssl_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          lb_client_ssl_profile == o.lb_client_ssl_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, lb_client_ssl_profile].hash
    end
