...
module SwaggerClient
  ...
  class LbHttpRequestBodyCondition
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'body_value')
        self.body_value = attributes[:'body_value']
      end
    ...
    def list_invalid_properties
      ...
      if @body_value.nil?
        invalid_properties.push('invalid value for "body_value", body_value cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @body_value.nil?
    ...
    def hash
      [inverse, type, body_value, match_type, case_sensitive].hash
    end
