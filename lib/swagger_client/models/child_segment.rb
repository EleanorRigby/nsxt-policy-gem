...
module SwaggerClient
  ...
  class ChildSegment
    ...
    def list_invalid_properties
      ...
      if @segment.nil?
        invalid_properties.push('invalid value for "segment", segment cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, segment].hash
    end
