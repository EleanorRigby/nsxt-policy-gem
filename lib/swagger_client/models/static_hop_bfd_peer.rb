...
module SwaggerClient
  class StaticHopBfdPeer
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'peer_ip_address')
        self.peer_ip_address = attributes[:'peer_ip_address']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @peer_ip_address.nil?
        invalid_properties.push('invalid value for "peer_ip_address", peer_ip_address cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @peer_ip_address.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enabled == o.enabled &&
          peer_ip_address == o.peer_ip_address
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, source_addresses, bfd_config, enabled, peer_ip_address].hash
    end
