...
module SwaggerClient
  class LogicalPort
    ...
    attr_accessor :ignore_address_bindings
    ...
    def self.swagger_types
      {
        ...
        :'ignore_address_bindings' => :'Array<PacketAddressClassifier>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'init_state')
        self.init_state = attributes[:'init_state']
      end
      ...
      if attributes.has_key?(:'ignore_address_bindings')
        if (value = attributes[:'ignore_address_bindings']).is_a?(Array)
          self.ignore_address_bindings = value
        end
      end
    end
    ...
    def valid?
      ...
      init_state_validator = EnumAttributeValidator.new('String', ['UNBLOCKED_VLAN'])
      return false unless init_state_validator.valid?(@init_state)
    ...
    # @param [Object] init_state Object to be assigned
    def init_state=(init_state)
      validator = EnumAttributeValidator.new('String', ['UNBLOCKED_VLAN'])
      unless validator.valid?(init_state)
        fail ArgumentError, 'invalid value for "init_state", must be one of #{validator.allowable_values}.'
      end
      @init_state = init_state
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ignore_address_bindings == o.ignore_address_bindings
    end
