...
module SwaggerClient
  ...
  class MultiWidgetConfiguration
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, datasources, weight, icons, shared, footer, drilldown_id, is_drilldown, legend, widgets, navigation].hash
    end
