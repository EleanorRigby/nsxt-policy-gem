...
module SwaggerClient
  ...
  class LocaleServices
    ...
    attr_accessor :preferred_edge_paths

    # Policy path to edge cluster. Auto-assigned if associated enforcement-point has only one edge cluster. 
    ...
    attr_accessor :route_redistribution_types
    ...
    def self.attribute_map
      {
        ...
        :'route_redistribution_types' => :'route_redistribution_types'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'preferred_edge_paths' => :'Array<String>',
        :'edge_cluster_path' => :'String',
        :'route_redistribution_types' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'preferred_edge_paths')
        if (value = attributes[:'preferred_edge_paths']).is_a?(Array)
          self.preferred_edge_paths = value
        end
      end
      ...
      if attributes.has_key?(:'route_redistribution_types')
        if (value = attributes[:'route_redistribution_types']).is_a?(Array)
          self.route_redistribution_types = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          preferred_edge_paths == o.preferred_edge_paths &&
          edge_cluster_path == o.edge_cluster_path &&
          route_redistribution_types == o.route_redistribution_types
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, preferred_edge_paths, edge_cluster_path, route_redistribution_types].hash
    end
