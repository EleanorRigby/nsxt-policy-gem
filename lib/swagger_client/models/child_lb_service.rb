...
module SwaggerClient
  ...
  class ChildLBService
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LBService')
        self.lb_service = attributes[:'LBService']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lb_service.nil?
        invalid_properties.push('invalid value for "lb_service", lb_service cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @lb_service.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, lb_service].hash
    end
