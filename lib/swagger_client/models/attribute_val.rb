...
module SwaggerClient
  ...
  class AttributeVal
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'multivalue')
    ...
    def valid?
      data_type_validator = EnumAttributeValidator.new('String', ['STRING', 'DATE', 'INTEGER', 'BOOLEAN'])
    ...
    def data_type=(data_type)
      validator = EnumAttributeValidator.new('String', ['STRING', 'DATE', 'INTEGER', 'BOOLEAN'])
    ...
    def hash
      [values, multivalue, key, data_type].hash
    end
