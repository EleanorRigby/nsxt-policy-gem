...
module SwaggerClient
  ...
  class ChildDhcpServerConfig
    ...
    attr_accessor :dhcp_server_config
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DhcpServerConfig')
        self.dhcp_server_config = attributes[:'DhcpServerConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @dhcp_server_config.nil?
        invalid_properties.push('invalid value for "dhcp_server_config", dhcp_server_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dhcp_server_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dhcp_server_config == o.dhcp_server_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, dhcp_server_config].hash
    end
