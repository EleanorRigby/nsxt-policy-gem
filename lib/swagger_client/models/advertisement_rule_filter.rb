...
module SwaggerClient
  ...
  class AdvertisementRuleFilter
    ...
    attr_accessor :match_route_types
    ...
    def self.swagger_types
      {
        ...
        :'match_route_types' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'match_route_types')
        if (value = attributes[:'match_route_types']).is_a?(Array)
          self.match_route_types = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @prefix_operator.nil?
        invalid_properties.push('invalid value for "prefix_operator", prefix_operator cannot be nil.')
      end

      if @match_route_types.nil?
        invalid_properties.push('invalid value for "match_route_types", match_route_types cannot be nil.')
      end
    ...
    def valid?
      return false if @prefix_operator.nil?
      ...
      return false if @match_route_types.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          match_route_types == o.match_route_types
    end
    ...
    def hash
      [prefix_operator, match_route_types].hash
    end
