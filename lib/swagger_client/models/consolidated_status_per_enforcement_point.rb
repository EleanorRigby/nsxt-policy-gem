...
module SwaggerClient
  ...
  class ConsolidatedStatusPerEnforcementPoint
    # Detailed consolidated realized status for intent object
    attr_accessor :consolidated_status

    # Enforcement point id used to consolidate state
    attr_accessor :enforcement_point_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'enforcement_point_id')
        self.enforcement_point_id = attributes[:'enforcement_point_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enforcement_point_id == o.enforcement_point_id
    end
    ...
    def hash
      [consolidated_status, enforcement_point_id].hash
    end
