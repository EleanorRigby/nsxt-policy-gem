...
module SwaggerClient
  class CapacityDashboardUsage
    ...
    def usage_type=(usage_type)
      validator = EnumAttributeValidator.new('String', ['NUMBER_OF_MANAGERS', 'NUMBER_OF_CONTROLLERS', 'NUMBER_OF_LOGICAL_SWITCHES', 'NUMBER_OF_PREPARED_HOSTS', 'NUMBER_OF_SYSTEM_WIDE_VIFS', 'NUMBER_OF_NSGROUP', 'NUMBER_OF_VCENTER_CLUSTERS', 'NUMBER_OF_DFW_RULES', 'NUMBER_OF_DFW_SECTIONS', 'NUMBER_OF_L2_DFW_SECTIONS', 'NUMBER_OF_L3_DFW_SECTIONS', 'NUMBER_OF_L2_DFW_RULES', 'NUMBER_OF_L3_DFW_RULES', 'NUMBER_OF_L3_EDGE_SECTIONS', 'NUMBER_OF_L3_EDGE_RULES', 'NUMBER_OF_L3_BRIDGEPORT_SECTIONS', 'NUMBER_OF_L3_BRIDGEPORT_RULES'])
