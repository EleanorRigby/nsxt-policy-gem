...
module SwaggerClient
  ...
  class ChildL2VPNSession
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'L2VPNSession')
        self.l2_vpn_session = attributes[:'L2VPNSession']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @l2_vpn_session.nil?
        invalid_properties.push('invalid value for "l2_vpn_session", l2_vpn_session cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @l2_vpn_session.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          l2_vpn_session == o.l2_vpn_session
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, l2_vpn_session].hash
    end
