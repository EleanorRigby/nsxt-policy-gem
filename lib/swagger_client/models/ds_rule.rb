...
module SwaggerClient
  class DSRule
    ...
    def hash
      [_self, _links, _schema, _revision, _owner, display_name, id, resource_type, description, is_default, direction, rule_tag, ip_protocol, notes, applied_tos, logged, disabled, sources, action, sources_excluded, destinations_excluded, destinations].hash
    end
