...
module SwaggerClient
  ...
  class ChildLBPersistenceProfile
    ...
    def self.attribute_map
      {
        ...
        :'lb_persistence_profile' => :'LBPersistenceProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LBPersistenceProfile')
        self.lb_persistence_profile = attributes[:'LBPersistenceProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lb_persistence_profile.nil?
        invalid_properties.push('invalid value for "lb_persistence_profile", lb_persistence_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @lb_persistence_profile.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, lb_persistence_profile].hash
    end
