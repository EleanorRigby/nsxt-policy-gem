...
module SwaggerClient
  class LbSslCipherAndProtocolListResult
    ...
    def self.swagger_types
      {
        ...
        :'ciphers' => :'Array<LbSslCipherInfo>',
        :'protocols' => :'Array<LbSslProtocolInfo>'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @ciphers.nil?
        invalid_properties.push('invalid value for "ciphers", ciphers cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, ciphers, protocols].hash
    end
