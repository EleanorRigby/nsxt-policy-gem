...
module SwaggerClient
  ...
  class RealizedNSService
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['RealizedNSService'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @state.nil?
      state_validator = EnumAttributeValidator.new('String', ['UNAVAILABLE', 'UNREALIZED', 'REALIZED', 'ERROR'])
      return false unless state_validator.valid?(@state)
      service_type_validator = EnumAttributeValidator.new('String', ['SERVICE', 'SERVICE_GROUP'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['RealizedNSService'])
    ...
    def service_type=(service_type)
      validator = EnumAttributeValidator.new('String', ['SERVICE', 'SERVICE_GROUP'])
