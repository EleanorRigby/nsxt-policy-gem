...
module SwaggerClient
  ...
  class ChildPolicyServiceProfile
    ...
    attr_accessor :policy_service_profile
    ...
    def self.attribute_map
      {
        ...
        :'policy_service_profile' => :'PolicyServiceProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyServiceProfile')
        self.policy_service_profile = attributes[:'PolicyServiceProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_service_profile.nil?
        invalid_properties.push('invalid value for "policy_service_profile", policy_service_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_service_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_service_profile == o.policy_service_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_service_profile].hash
    end
