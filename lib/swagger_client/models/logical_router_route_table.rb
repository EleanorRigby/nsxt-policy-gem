...
module SwaggerClient
  class LogicalRouterRouteTable
    ...
    attr_accessor :logical_router_name
    ...
    def self.swagger_types
      {
        ...
        :'results' => :'Array<LogicalRouterRouteEntry>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'logical_router_name')
        self.logical_router_name = attributes[:'logical_router_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          logical_router_name == o.logical_router_name &&
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, logical_router_name, last_update_timestamp, logical_router_id, results].hash
    end
