...
module SwaggerClient
  ...
  class ChildEndpointRule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'EndpointRule')
        self.endpoint_rule = attributes[:'EndpointRule']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @endpoint_rule.nil?
        invalid_properties.push('invalid value for "endpoint_rule", endpoint_rule cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @endpoint_rule.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, endpoint_rule].hash
    end
