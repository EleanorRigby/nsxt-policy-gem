...
module SwaggerClient
  ...
  class DomainDeploymentMap
    ...
    def list_invalid_properties
      ...
      if @enforcement_point_path.nil?
        invalid_properties.push('invalid value for "enforcement_point_path", enforcement_point_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @enforcement_point_path.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, enforcement_point_path].hash
    end
