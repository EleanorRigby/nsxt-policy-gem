...
module SwaggerClient
  ...
  class LBServiceUsage
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, pool_capacity, service_size, pool_member_capacity, current_virtual_server_count, last_update_timestamp, current_pool_count, virtual_server_capacity, current_pool_member_count, service_path].hash
    end
