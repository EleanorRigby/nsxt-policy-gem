...
module SwaggerClient
  ...
  class ConstraintTarget
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'target_resource_type')
        self.target_resource_type = attributes[:'target_resource_type']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @target_resource_type.nil?
        invalid_properties.push('invalid value for "target_resource_type", target_resource_type cannot be nil.')
      end
    ...
    def valid?
      return false if @target_resource_type.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          target_resource_type == o.target_resource_type
    end
    ...
    def hash
      [attribute, path_prefix, target_resource_type].hash
    end
