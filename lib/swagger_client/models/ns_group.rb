...
module SwaggerClient
  ...
  class NSGroup
    ...
    attr_accessor :membership_criteria
    ...
    def self.swagger_types
      {
        ...
        :'members' => :'Array<NSGroupSimpleExpression>',
        :'membership_criteria' => :'Array<NSGroupExpression>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'membership_criteria')
        if (value = attributes[:'membership_criteria']).is_a?(Array)
          self.membership_criteria = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          members == o.members &&
          membership_criteria == o.membership_criteria
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, member_count, members, membership_criteria].hash
    end
