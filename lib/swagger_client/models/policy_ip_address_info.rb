...
module SwaggerClient
  ...
  class PolicyIPAddressInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'address_value')
        self.address_value = attributes[:'address_value']
      end
    ...
    def list_invalid_properties
      ...
      if @address_value.nil?
        invalid_properties.push('invalid value for "address_value", address_value cannot be nil.')
      end
    ...
    def valid?
      return false if @address_value.nil?
      true
    end
    ...
    def hash
      [next_hop, address_value, display_name].hash
    end
