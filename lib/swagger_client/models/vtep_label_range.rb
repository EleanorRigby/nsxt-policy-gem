...
module SwaggerClient
  class VtepLabelRange
    ...
    def list_invalid_properties
      ...
      if @start > 131071
        invalid_properties.push('invalid value for "start", must be smaller than or equal to 131071.')
      end
      ...
      if @_end > 131071
        invalid_properties.push('invalid value for "_end", must be smaller than or equal to 131071.')
      end
    ...
    def valid?
      ...
      return false if @start > 131071
      return false if @start < 1
      return false if @_end.nil?
      return false if @_end > 131071
    ...
    def start=(start)
      ...
      if start > 131071
        fail ArgumentError, 'invalid value for "start", must be smaller than or equal to 131071.'
      end

      if start < 1
        fail ArgumentError, 'invalid value for "start", must be greater than or equal to 1.'
      end
    ...
    def _end=(_end)
      ...
      if _end > 131071
        fail ArgumentError, 'invalid value for "_end", must be smaller than or equal to 131071.'
      end
