...
module SwaggerClient
  class TransportZone
    ...
    attr_accessor :uplink_teaming_policy_names

    # Identifiers of the transport zone profiles associated with this TransportZone.
    attr_accessor :transport_zone_profile_ids
    ...
    def self.swagger_types
      {
        ...
        :'nested_nsx' => :'BOOLEAN',
        :'uplink_teaming_policy_names' => :'Array<String>',
        :'transport_zone_profile_ids' => :'Array<TransportZoneProfileTypeIdEntry>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'host_switch_mode')
        ...
        self.host_switch_mode = 'STANDARD'
      end

      if attributes.has_key?(:'nested_nsx')
        self.nested_nsx = attributes[:'nested_nsx']
      else
        self.nested_nsx = false
      end

      if attributes.has_key?(:'uplink_teaming_policy_names')
        if (value = attributes[:'uplink_teaming_policy_names']).is_a?(Array)
          self.uplink_teaming_policy_names = value
        end
      end

      if attributes.has_key?(:'transport_zone_profile_ids')
        if (value = attributes[:'transport_zone_profile_ids']).is_a?(Array)
          self.transport_zone_profile_ids = value
        end
      end
    end
    ...
    def valid?
      ...
      transport_type_validator = EnumAttributeValidator.new('String', ['OVERLAY', 'VLAN'])
      return false unless transport_type_validator.valid?(@transport_type)
      host_switch_mode_validator = EnumAttributeValidator.new('String', ['STANDARD', 'ENS'])
    ...
    def transport_type=(transport_type)
      validator = EnumAttributeValidator.new('String', ['OVERLAY', 'VLAN'])
    ...
    def host_switch_mode=(host_switch_mode)
      validator = EnumAttributeValidator.new('String', ['STANDARD', 'ENS'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          nested_nsx == o.nested_nsx &&
          uplink_teaming_policy_names == o.uplink_teaming_policy_names &&
          transport_zone_profile_ids == o.transport_zone_profile_ids
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, is_default, transport_type, host_switch_id, host_switch_name, host_switch_mode, nested_nsx, uplink_teaming_policy_names, transport_zone_profile_ids].hash
    end
