...
module SwaggerClient
  ...
  class BgpRoutingConfig
    ...
    def self.swagger_types
      {
        ...
        :'route_aggregations' => :'Array<RouteAggregationEntry>',
        :'enabled' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'local_as_num')
        self.local_as_num = attributes[:'local_as_num']
      end
      ...
      if attributes.has_key?(:'route_aggregations')
        if (value = attributes[:'route_aggregations']).is_a?(Array)
          self.route_aggregations = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @local_as_num.nil?
        invalid_properties.push('invalid value for "local_as_num", local_as_num cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @local_as_num.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          local_as_num == o.local_as_num &&
          graceful_restart == o.graceful_restart &&
          route_aggregations == o.route_aggregations &&
          enabled == o.enabled &&
