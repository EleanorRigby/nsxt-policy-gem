...
module SwaggerClient
  ...
  class IPSecVPNIKEProfile
    ...
    def list_invalid_properties
      ...
      if !@sa_life_time.nil? && @sa_life_time < 21600
        invalid_properties.push('invalid value for "sa_life_time", must be greater than or equal to 21600.')
      end
    ...
    def valid?
      ...
      return false if !@sa_life_time.nil? && @sa_life_time < 21600
    ...
    def sa_life_time=(sa_life_time)
      ...
      if !sa_life_time.nil? && sa_life_time < 21600
        fail ArgumentError, 'invalid value for "sa_life_time", must be greater than or equal to 21600.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, digest_algorithms, encryption_algorithms, dh_groups, sa_life_time, ike_version].hash
    end
