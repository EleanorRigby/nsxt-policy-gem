...
module SwaggerClient
  ...
  class ChildStaticRoutes
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'StaticRoutes')
    ...
    def list_invalid_properties
      ...
      if @static_routes.nil?
        invalid_properties.push('invalid value for "static_routes", static_routes cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @static_routes.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, static_routes].hash
    end
