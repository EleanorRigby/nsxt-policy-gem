...
module SwaggerClient
  ...
  class ChildPolicyLabel
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyLabel')
        self.policy_label = attributes[:'PolicyLabel']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_label.nil?
        invalid_properties.push('invalid value for "policy_label", policy_label cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_label.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_label].hash
    end
