...
module SwaggerClient
  ...
  class ServiceManager
    ...
    def self.swagger_types
      {
        ...
        :'port' => :'Integer',
        :'service_ids' => :'Array<ResourceReference>',
    ...
    def list_invalid_properties
      ...
      if @service_ids.nil?
        invalid_properties.push('invalid value for "service_ids", service_ids cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @service_ids.nil?
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, port, service_ids, authentication_scheme, thumbprint, vendor_id, uri, server].hash
    end
