...
module SwaggerClient
  ...
  class BatchRequestItem
    ...
    def valid?
      ...
      method_validator = EnumAttributeValidator.new('String', ['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('String', ['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])
