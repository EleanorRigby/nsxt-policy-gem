...
module SwaggerClient
  ...
  class PolicyServiceInstance
    ...
    def list_invalid_properties
      ...
      if @secondary_interface_mgmt_ip.nil?
        invalid_properties.push('invalid value for "secondary_interface_mgmt_ip", secondary_interface_mgmt_ip cannot be nil.')
      end
      ...
      if @secondary_interface_network.nil?
        invalid_properties.push('invalid value for "secondary_interface_network", secondary_interface_network cannot be nil.')
      end

      if @primary_interface_network.nil?
        invalid_properties.push('invalid value for "primary_interface_network", primary_interface_network cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @secondary_interface_mgmt_ip.nil?
      ...
      return false if @secondary_interface_network.nil?
      return false if @primary_interface_network.nil?
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, partner_service_name, transport_type, deployment_mode, primary_interface_mgmt_ip, context_id, secondary_interface_mgmt_ip, compute_id, deployment_spec_name, deployment_template_name, storage_id, attributes, secondary_interface_network, primary_interface_network, failure_policy].hash
    end
