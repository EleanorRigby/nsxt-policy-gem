...
module SwaggerClient
  ...
  class LBIcmpMonitorProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'data_length')
        self.data_length = attributes[:'data_length']
      else
        self.data_length = 56
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@data_length.nil? && @data_length > 65507
        invalid_properties.push('invalid value for "data_length", must be smaller than or equal to 65507.')
      end

      if !@data_length.nil? && @data_length < 0
        invalid_properties.push('invalid value for "data_length", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@data_length.nil? && @data_length > 65507
      return false if !@data_length.nil? && @data_length < 0
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] data_length Value to be assigned
    def data_length=(data_length)
      if !data_length.nil? && data_length > 65507
        fail ArgumentError, 'invalid value for "data_length", must be smaller than or equal to 65507.'
      end

      if !data_length.nil? && data_length < 0
        fail ArgumentError, 'invalid value for "data_length", must be greater than or equal to 0.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, monitor_port, fall_count, interval, rise_count, timeout, data_length].hash
    end
