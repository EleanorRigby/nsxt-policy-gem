...
module SwaggerClient
  ...
  class CommunicationMap
    ...
    attr_accessor :communication_entries
    ...
    def self.swagger_types
      {
        ...
        :'communication_entries' => :'Array<CommunicationEntry>',
        :'category' => :'String',
        :'precedence' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'communication_entries')
        if (value = attributes[:'communication_entries']).is_a?(Array)
          self.communication_entries = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          communication_entries == o.communication_entries &&
          category == o.category &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, communication_entries, category, precedence].hash
    end
