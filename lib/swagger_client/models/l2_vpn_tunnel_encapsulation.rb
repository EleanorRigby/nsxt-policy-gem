...
module SwaggerClient
  ...
  class L2VpnTunnelEncapsulation
    ...
    attr_accessor :local_endpoint_ip
    ...
    attr_accessor :peer_endpoint_ip
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'local_endpoint_ip')
        self.local_endpoint_ip = attributes[:'local_endpoint_ip']
      end
      ...
      if attributes.has_key?(:'peer_endpoint_ip')
        self.peer_endpoint_ip = attributes[:'peer_endpoint_ip']
      end
    end
    ...
    def valid?
      protocol_validator = EnumAttributeValidator.new('String', ['GRE'])
    ...
    def protocol=(protocol)
      validator = EnumAttributeValidator.new('String', ['GRE'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          local_endpoint_ip == o.local_endpoint_ip &&
          protocol == o.protocol &&
          peer_endpoint_ip == o.peer_endpoint_ip
    end
    ...
    def hash
      [local_endpoint_ip, protocol, peer_endpoint_ip].hash
    end
