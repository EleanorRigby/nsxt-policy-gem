...
module SwaggerClient
  ...
  class ChildPolicyEdgeNode
    ...
    attr_accessor :policy_edge_node
    ...
    def self.attribute_map
      {
        ...
        :'policy_edge_node' => :'PolicyEdgeNode'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyEdgeNode')
        self.policy_edge_node = attributes[:'PolicyEdgeNode']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_edge_node.nil?
        invalid_properties.push('invalid value for "policy_edge_node", policy_edge_node cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_edge_node.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_edge_node == o.policy_edge_node
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_edge_node].hash
    end
