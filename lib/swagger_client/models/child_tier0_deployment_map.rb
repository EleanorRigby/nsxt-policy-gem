...
module SwaggerClient
  ...
  class ChildTier0DeploymentMap
    ...
    attr_accessor :tier0_deployment_map
    ...
    def self.attribute_map
      {
        ...
        :'tier0_deployment_map' => :'Tier0DeploymentMap'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Tier0DeploymentMap')
        self.tier0_deployment_map = attributes[:'Tier0DeploymentMap']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tier0_deployment_map.nil?
        invalid_properties.push('invalid value for "tier0_deployment_map", tier0_deployment_map cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tier0_deployment_map.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tier0_deployment_map == o.tier0_deployment_map
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, tier0_deployment_map].hash
    end
