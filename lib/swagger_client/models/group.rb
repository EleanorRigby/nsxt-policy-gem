...
module SwaggerClient
  ...
  class Group
    ...
    attr_accessor :extended_expression
    ...
    def self.attribute_map
      {
        ...
        :'state' => :'state',
        :'extended_expression' => :'extended_expression',
    ...
    def self.swagger_types
      {
        ...
        :'state' => :'String',
        :'extended_expression' => :'Array<Expression>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'extended_expression')
        if (value = attributes[:'extended_expression']).is_a?(Array)
          self.extended_expression = value
        end
      end
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ['IN_PROGRESS', 'SUCCESS', 'FAILURE'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          state == o.state &&
          extended_expression == o.extended_expression &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, state, extended_expression, expression].hash
    end
