...
module SwaggerClient
  class LogicalPortMacAddressListResult
    ...
    def self.swagger_types
      {
        ...
        :'results' => :'Array<LogicalPortMacTableEntry>',
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, logical_port_id, last_update_timestamp, results, transport_node_id].hash
    end
