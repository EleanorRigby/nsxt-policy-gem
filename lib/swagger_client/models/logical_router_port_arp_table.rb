...
module SwaggerClient
  class LogicalRouterPortArpTable
    ...
    def self.swagger_types
      {
        ...
        :'results' => :'Array<LogicalRouterPortArpEntry>',
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, last_update_timestamp, results, logical_router_port_id].hash
    end
