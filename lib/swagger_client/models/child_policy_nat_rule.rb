...
module SwaggerClient
  ...
  class ChildPolicyNatRule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyNatRule')
        self.policy_nat_rule = attributes[:'PolicyNatRule']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_nat_rule.nil?
        invalid_properties.push('invalid value for "policy_nat_rule", policy_nat_rule cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_nat_rule.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_nat_rule == o.policy_nat_rule
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_nat_rule].hash
    end
