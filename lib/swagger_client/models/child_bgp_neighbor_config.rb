...
module SwaggerClient
  ...
  class ChildBgpNeighborConfig
    ...
    attr_accessor :bgp_routing_config
    ...
    def self.attribute_map
      {
        ...
        :'bgp_routing_config' => :'BgpRoutingConfig'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'bgp_routing_config' => :'BgpNeighborConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'BgpRoutingConfig')
        self.bgp_routing_config = attributes[:'BgpRoutingConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @bgp_routing_config.nil?
        invalid_properties.push('invalid value for "bgp_routing_config", bgp_routing_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @bgp_routing_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bgp_routing_config == o.bgp_routing_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, bgp_routing_config].hash
    end
