...
module SwaggerClient
  class TraceflowObservationDropped
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, reason, lport_name, acl_rule_id, lport_id].hash
    end
