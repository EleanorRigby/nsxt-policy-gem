...
module SwaggerClient
  ...
  class ChildL3VpnContext
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'L3VpnContext')
        self.l3_vpn_context = attributes[:'L3VpnContext']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @l3_vpn_context.nil?
        invalid_properties.push('invalid value for "l3_vpn_context", l3_vpn_context cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @l3_vpn_context.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          l3_vpn_context == o.l3_vpn_context
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, l3_vpn_context].hash
    end
