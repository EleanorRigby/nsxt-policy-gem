...
module SwaggerClient
  ...
  class ChildGatewayPolicy
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'GatewayPolicy')
        self.gateway_policy = attributes[:'GatewayPolicy']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @gateway_policy.nil?
        invalid_properties.push('invalid value for "gateway_policy", gateway_policy cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @gateway_policy.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gateway_policy == o.gateway_policy
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, gateway_policy].hash
    end
