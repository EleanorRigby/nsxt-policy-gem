...
module SwaggerClient
  ...
  class ConfigurationStateElement
    ...
    def valid?
      state_validator = EnumAttributeValidator.new('String', ['in_progress', 'success', 'failed', 'partial_success'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['in_progress', 'success', 'failed', 'partial_success'])
