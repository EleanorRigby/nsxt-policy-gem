...
module SwaggerClient
  ...
  class ChildStaticARPConfig
    ...
    attr_accessor :static_arp_config
    ...
    def self.attribute_map
      {
        ...
        :'static_arp_config' => :'StaticARPConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'StaticARPConfig')
        self.static_arp_config = attributes[:'StaticARPConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @static_arp_config.nil?
        invalid_properties.push('invalid value for "static_arp_config", static_arp_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @static_arp_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          static_arp_config == o.static_arp_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, static_arp_config].hash
    end
