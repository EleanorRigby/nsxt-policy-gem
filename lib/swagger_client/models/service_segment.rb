...
module SwaggerClient
  ...
  class ServiceSegment
    ...
    def list_invalid_properties
      ...
      if @transport_zone_path.nil?
        invalid_properties.push('invalid value for "transport_zone_path", transport_zone_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @transport_zone_path.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, transport_zone_path].hash
    end
