...
module SwaggerClient
  class PrincipalIdentityWithCertificate
    ...
    attr_accessor :permission_group
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'is_protected')
      ...
      if attributes.has_key?(:'permission_group')
        self.permission_group = attributes[:'permission_group']
      end
      ...
      if attributes.has_key?(:'certificate_pem')
    ...
    def list_invalid_properties
      ...
      if @node_id.to_s.length > 255
        invalid_properties.push('invalid value for "node_id", the character length must be smaller than or equal to 255.')
      end
    ...
    def valid?
      ...
      permission_group_validator = EnumAttributeValidator.new('String', ['read_only_api_users', 'read_write_api_users', 'superusers', 'undefined'])
    ...
    def permission_group=(permission_group)
      validator = EnumAttributeValidator.new('String', ['read_only_api_users', 'read_write_api_users', 'superusers', 'undefined'])
    ...
    def node_id=(node_id)
      ...
      if node_id.to_s.length > 255
        fail ArgumentError, 'invalid value for "node_id", the character length must be smaller than or equal to 255.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, is_protected, role, name, permission_group, certificate_id, node_id, certificate_pem].hash
    end
