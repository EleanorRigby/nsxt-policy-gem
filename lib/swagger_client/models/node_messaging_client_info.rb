...
module SwaggerClient
  class NodeMessagingClientInfo
    ...
    def self.swagger_types
      {
        :'clients' => :'Array<MessagingClientInfo>',
        :'entity_type' => :'String'
      }
    end
    ...
    def valid?
      entity_type_validator = EnumAttributeValidator.new('String', ['HTTP', 'DATASTORE', 'MANAGER', 'POLICY', 'CONTROLLER'])
    ...
    def entity_type=(entity_type)
      validator = EnumAttributeValidator.new('String', ['HTTP', 'DATASTORE', 'MANAGER', 'POLICY', 'CONTROLLER'])
