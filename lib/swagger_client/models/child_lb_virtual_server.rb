...
module SwaggerClient
  ...
  class ChildLBVirtualServer
    ...
    attr_accessor :lb_virtual_server
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LBVirtualServer')
        self.lb_virtual_server = attributes[:'LBVirtualServer']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lb_virtual_server.nil?
        invalid_properties.push('invalid value for "lb_virtual_server", lb_virtual_server cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @lb_virtual_server.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          lb_virtual_server == o.lb_virtual_server
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, lb_virtual_server].hash
    end
