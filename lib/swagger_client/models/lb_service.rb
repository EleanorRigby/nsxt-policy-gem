...
module SwaggerClient
  ...
  class LBService
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'error_log_level')
        self.error_log_level = attributes[:'error_log_level']
      else
        self.error_log_level = 'INFO'
      end
    ...
    def valid?
      ...
      error_log_level_validator = EnumAttributeValidator.new('String', ['DEBUG', 'INFO', 'WARNING', 'ERROR', 'CRITICAL', 'ALERT', 'EMERGENCY'])
      return false unless error_log_level_validator.valid?(@error_log_level)
      size_validator = EnumAttributeValidator.new('String', ['SMALL', 'MEDIUM', 'LARGE'])
    ...
    # @param [Object] error_log_level Object to be assigned
    def error_log_level=(error_log_level)
      validator = EnumAttributeValidator.new('String', ['DEBUG', 'INFO', 'WARNING', 'ERROR', 'CRITICAL', 'ALERT', 'EMERGENCY'])
      unless validator.valid?(error_log_level)
        fail ArgumentError, 'invalid value for "error_log_level", must be one of #{validator.allowable_values}.'
      end
      @error_log_level = error_log_level
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          error_log_level == o.error_log_level &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, enabled, connectivity_path, error_log_level, access_log_enabled, size].hash
    end
