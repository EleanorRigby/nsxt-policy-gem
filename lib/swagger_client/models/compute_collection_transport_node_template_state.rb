...
module SwaggerClient
  ...
  class ComputeCollectionTransportNodeTemplateState
    ...
    def self.swagger_types
      {
        ...
        :'template_states' => :'Array<TransportNodeTemplateState>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'template_states')
        if (value = attributes[:'template_states']).is_a?(Array)
          self.template_states = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          template_states == o.template_states
    end
    ...
    def hash
      [compute_collection_id, template_states].hash
    end
