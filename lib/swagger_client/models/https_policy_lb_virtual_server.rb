...
module SwaggerClient
  ...
  class HttpsPolicyLbVirtualServer
    ...
    def list_invalid_properties
      ...
      if @default_client_ssl_certificate_id.nil?
        invalid_properties.push('invalid value for "default_client_ssl_certificate_id", default_client_ssl_certificate_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @default_client_ssl_certificate_id.nil?
      true
    end
