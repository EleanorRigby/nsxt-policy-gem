  ...
  class RealizedFirewalls
    ...
    def self.swagger_types
      {
        ...
        :'realized_firewalls' => :'Array<RealizedFirewall>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'realized_firewalls')
        if (value = attributes[:'realized_firewalls']).is_a?(Array)
          self.realized_firewalls = value
        end
      end
    end
