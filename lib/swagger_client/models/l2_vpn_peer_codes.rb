...
module SwaggerClient
  ...
  class L2VpnPeerCodes
    ...
    def self.swagger_types
      {
        ...
        :'peer_codes' => :'Array<L2VpnTransportTunnelPeerCode>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'peer_codes')
        if (value = attributes[:'peer_codes']).is_a?(Array)
          self.peer_codes = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @peer_codes.nil?
        invalid_properties.push('invalid value for "peer_codes", peer_codes cannot be nil.')
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['L2VpnPeerCodes'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @peer_codes.nil?
      true
    end
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['L2VpnPeerCodes'])
    ...
    def hash
      [resource_type, enforcement_point_path, peer_codes].hash
    end
