...
module SwaggerClient
  class EdgeCluster
    ...
    attr_accessor :member_node_type

    # Edge cluster profile bindings
    attr_accessor :cluster_profile_bindings
    ...
    def self.swagger_types
      {
        ...
        :'cluster_profile_bindings' => :'Array<ClusterProfileTypeIdEntry>',
        :'members' => :'Array<EdgeClusterMember>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'member_node_type')
        self.member_node_type = attributes[:'member_node_type']
      end

      if attributes.has_key?(:'cluster_profile_bindings')
        if (value = attributes[:'cluster_profile_bindings']).is_a?(Array)
          self.cluster_profile_bindings = value
        end
      end
    ...
    def valid?
      ...
      member_node_type_validator = EnumAttributeValidator.new('String', ['EDGE_NODE', 'PUBLIC_CLOUD_GATEWAY_NODE', 'UNKNOWN'])
      return false unless member_node_type_validator.valid?(@member_node_type)
    ...
    # @param [Object] member_node_type Object to be assigned
    def member_node_type=(member_node_type)
      validator = EnumAttributeValidator.new('String', ['EDGE_NODE', 'PUBLIC_CLOUD_GATEWAY_NODE', 'UNKNOWN'])
      unless validator.valid?(member_node_type)
        fail ArgumentError, 'invalid value for "member_node_type", must be one of #{validator.allowable_values}.'
      end
      @member_node_type = member_node_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          member_node_type == o.member_node_type &&
          cluster_profile_bindings == o.cluster_profile_bindings &&
          members == o.members &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, member_node_type, cluster_profile_bindings, members, deployment_type].hash
    end
