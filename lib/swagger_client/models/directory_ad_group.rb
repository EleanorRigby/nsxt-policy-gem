...
module SwaggerClient
  class DirectoryAdGroup
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'domain_sync_node_id')
      ...
      if attributes.has_key?(:'domain_id')
      ...
      if attributes.has_key?(:'object_guid')
        self.object_guid = attributes[:'object_guid']
      end

      if attributes.has_key?(:'secure_id')
    ...
    def list_invalid_properties
      ...
      if @domain_sync_node_id.nil?
        invalid_properties.push('invalid value for "domain_sync_node_id", domain_sync_node_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @domain_sync_node_id.nil?
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, domain_sync_node_id, distinguished_name, domain_id, domain_name, object_guid, secure_id].hash
    end
