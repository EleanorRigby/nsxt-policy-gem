...
module SwaggerClient
  class NatRule
    ...
    def valid?
      ...
      action_validator = EnumAttributeValidator.new('String', ['SNAT', 'DNAT', 'NO_NAT', 'REFLEXIVE', 'NO_SNAT', 'NO_DNAT'])
    ...
    def action=(action)
      validator = EnumAttributeValidator.new('String', ['SNAT', 'DNAT', 'NO_NAT', 'REFLEXIVE', 'NO_SNAT', 'NO_DNAT'])
