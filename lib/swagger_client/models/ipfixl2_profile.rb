...
module SwaggerClient
  ...
  class IPFIXL2Profile
    ...
    # Policy path for IPFIX collector profile. IPFIX data will be forwarded to all specified IPFIX collectors. 
    attr_accessor :ipfix_collector_profile_path
    ...
    def self.attribute_map
      {
        ...
        :'ipfix_collector_profile_path' => :'ipfix_collector_profile_path',
        :'max_flows' => :'max_flows',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ipfix_collector_profile_path')
        self.ipfix_collector_profile_path = attributes[:'ipfix_collector_profile_path']
      end
    ...
    def list_invalid_properties
      ...
      if @ipfix_collector_profile_path.nil?
        invalid_properties.push('invalid value for "ipfix_collector_profile_path", ipfix_collector_profile_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ipfix_collector_profile_path.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ipfix_collector_profile_path == o.ipfix_collector_profile_path &&
