...
module SwaggerClient
  ...
  class QoSDscp
    ...
    def list_invalid_properties
      ...
      if !@priority.nil? && @priority > 63
        invalid_properties.push('invalid value for "priority", must be smaller than or equal to 63.')
      end
    ...
    def valid?
      return false if !@priority.nil? && @priority > 63
      return false if !@priority.nil? && @priority < 0
      mode_validator = EnumAttributeValidator.new('String', ['TRUSTED', 'UNTRUSTED'])
    ...
    def priority=(priority)
      if !priority.nil? && priority > 63
        fail ArgumentError, 'invalid value for "priority", must be smaller than or equal to 63.'
      end
