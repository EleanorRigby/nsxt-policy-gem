...
module SwaggerClient
  ...
  class LbHttpRejectAction
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reply_status')
        self.reply_status = attributes[:'reply_status']
      end
    ...
    def list_invalid_properties
      ...
      if @reply_status.nil?
        invalid_properties.push('invalid value for "reply_status", reply_status cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @reply_status.nil?
      true
    end
    ...
    def hash
      [type, reply_status, reply_message].hash
    end
