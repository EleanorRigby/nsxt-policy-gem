...
module SwaggerClient
  ...
  class L2VPNSessionStatusNsxT
    ...
    def self.swagger_types
      {
        ...
        :'transport_tunnels' => :'Array<L2VPNSessionTransportTunnelStatus>',
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['L2VPNSessionStatusNsxT'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['L2VPNSessionStatusNsxT'])
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, transport_tunnels, runtime_status].hash
    end
