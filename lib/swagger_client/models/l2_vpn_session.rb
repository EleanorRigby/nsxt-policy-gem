...
module SwaggerClient
  ...
  class L2VPNSession
    ...
    def self.swagger_types
      {
        ...
        :'transport_tunnels' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transport_tunnels')
        if (value = attributes[:'transport_tunnels']).is_a?(Array)
          self.transport_tunnels = value
        end
      end

      if attributes.has_key?(:'tunnel_encapsulation')
        self.tunnel_encapsulation = attributes[:'tunnel_encapsulation']
      end
    ...
    def list_invalid_properties
      ...
      if @transport_tunnels.nil?
        invalid_properties.push('invalid value for "transport_tunnels", transport_tunnels cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @transport_tunnels.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transport_tunnels == o.transport_tunnels &&
          tunnel_encapsulation == o.tunnel_encapsulation &&
          enabled == o.enabled
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, transport_tunnels, tunnel_encapsulation, enabled].hash
    end
