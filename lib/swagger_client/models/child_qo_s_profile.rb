...
module SwaggerClient
  ...
  class ChildQoSProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'QoSProfile')
        self.qo_s_profile = attributes[:'QoSProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @qo_s_profile.nil?
        invalid_properties.push('invalid value for "qo_s_profile", qo_s_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @qo_s_profile.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, qo_s_profile].hash
    end
