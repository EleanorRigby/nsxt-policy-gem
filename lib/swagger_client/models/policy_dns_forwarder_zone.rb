...
module SwaggerClient
  ...
  class PolicyDnsForwarderZone
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dns_domain_names')
        if (value = attributes[:'dns_domain_names']).is_a?(Array)
          self.dns_domain_names = value
        end
      end

      if attributes.has_key?(:'upstream_servers')
        if (value = attributes[:'upstream_servers']).is_a?(Array)
          self.upstream_servers = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @upstream_servers.nil?
        invalid_properties.push('invalid value for "upstream_servers", upstream_servers cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @upstream_servers.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dns_domain_names == o.dns_domain_names &&
          upstream_servers == o.upstream_servers &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, dns_domain_names, upstream_servers, source_ip].hash
    end
