...
module SwaggerClient
  ...
  class ChildPolicyContextProfile
    ...
    attr_accessor :policy_context_profile
    ...
    def self.attribute_map
      {
        ...
        :'policy_context_profile' => :'PolicyContextProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyContextProfile')
        self.policy_context_profile = attributes[:'PolicyContextProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_context_profile.nil?
        invalid_properties.push('invalid value for "policy_context_profile", policy_context_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_context_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_context_profile == o.policy_context_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_context_profile].hash
    end
