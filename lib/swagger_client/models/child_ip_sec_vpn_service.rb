...
module SwaggerClient
  ...
  class ChildIPSecVpnService
    ...
    attr_accessor :ip_sec_vpn_service
    ...
    def self.attribute_map
      {
        ...
        :'ip_sec_vpn_service' => :'IPSecVpnService'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IPSecVpnService')
        self.ip_sec_vpn_service = attributes[:'IPSecVpnService']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ip_sec_vpn_service.nil?
        invalid_properties.push('invalid value for "ip_sec_vpn_service", ip_sec_vpn_service cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ip_sec_vpn_service.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ip_sec_vpn_service == o.ip_sec_vpn_service
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, ip_sec_vpn_service].hash
    end
