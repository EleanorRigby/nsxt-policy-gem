...
module SwaggerClient
  ...
  class LogicalRouterLinkPortOnTIER1
    ...
    attr_accessor :linked_logical_router_port_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'linked_logical_router_port_id')
        self.linked_logical_router_port_id = attributes[:'linked_logical_router_port_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          linked_logical_router_port_id == o.linked_logical_router_port_id &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, logical_router_id, service_bindings, subnets, mac_address, linked_logical_router_port_id, edge_cluster_member_index].hash
    end
