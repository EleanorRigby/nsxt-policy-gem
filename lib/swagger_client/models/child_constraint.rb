...
module SwaggerClient
  ...
  class ChildConstraint
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Constraint')
    ...
    def list_invalid_properties
      ...
      if @constraint.nil?
        invalid_properties.push('invalid value for "constraint", constraint cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, constraint].hash
    end
