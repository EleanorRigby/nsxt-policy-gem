...
module SwaggerClient
  ...
  class RealizedFirewallSection
    ...
    def self.swagger_types
      {
        ...
        :'rules' => :'Array<RealizedFirewallRule>',
        :'rule_count' => :'Integer',
        :'section_type' => :'String'
      }
    end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['RealizedFirewallSection'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @state.nil?
      state_validator = EnumAttributeValidator.new('String', ['UNAVAILABLE', 'UNREALIZED', 'REALIZED', 'ERROR'])
      return false unless state_validator.valid?(@state)
      section_type_validator = EnumAttributeValidator.new('String', ['LAYER2', 'LAYER3'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['RealizedFirewallSection'])
    ...
    def section_type=(section_type)
      validator = EnumAttributeValidator.new('String', ['LAYER2', 'LAYER3'])
