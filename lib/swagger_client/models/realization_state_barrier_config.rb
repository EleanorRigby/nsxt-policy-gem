...
module SwaggerClient
  ...
  class RealizationStateBarrierConfig
    ...
    def list_invalid_properties
      ...
      if @interval < 0
        invalid_properties.push('invalid value for "interval", must be greater than or equal to 0.')
      end
    ...
    def interval=(interval)
      ...
      if interval < 0
        fail ArgumentError, 'invalid value for "interval", must be greater than or equal to 0.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, interval].hash
    end
