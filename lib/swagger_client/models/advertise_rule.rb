...
module SwaggerClient
  class AdvertiseRule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rule_filter')
        self.rule_filter = attributes[:'rule_filter']
      end
    ...
    def valid?
      action_validator = EnumAttributeValidator.new('String', ['DENY', 'ALLOW'])
    ...
    def action=(action)
      validator = EnumAttributeValidator.new('String', ['DENY', 'ALLOW'])
    ...
    def hash
      [action, rule_filter, display_name, networks, description].hash
    end
