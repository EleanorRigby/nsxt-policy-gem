...
module SwaggerClient
  class MessagingClientInfo
    ...
    def valid?
      client_type_validator = EnumAttributeValidator.new('String', ['MPA', 'HOST'])
    ...
    def client_type=(client_type)
      validator = EnumAttributeValidator.new('String', ['MPA', 'HOST'])
