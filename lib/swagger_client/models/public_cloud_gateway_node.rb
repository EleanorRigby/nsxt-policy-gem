...
module SwaggerClient
  class PublicCloudGatewayNode
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, discovered_ip_addresses, ip_addresses, external_id, fqdn, deployment_config, allocation_list, deployment_type].hash
    end
