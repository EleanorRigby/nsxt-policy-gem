...
module SwaggerClient
  class BgpNeighbor
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, filter_in_ipprefixlist_id, allow_as_in, remote_as, filter_out_ipprefixlist_id, enable_bfd, hold_down_timer, maximum_hop_limit, enabled, bfd_config, logical_router_id, remote_as_num, filter_out_routemap_id, filter_in_routemap_id, keep_alive_timer, password, source_address, source_addresses, address_families, neighbor_address].hash
    end
