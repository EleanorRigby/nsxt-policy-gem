...
module SwaggerClient
  ...
  class IpfixSwitchUpmProfile
    ...
    attr_accessor :collector_profile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'collector_profile')
        self.collector_profile = attributes[:'collector_profile']
      end
      ...
      if attributes.has_key?(:'applied_tos')
        self.applied_tos = attributes[:'applied_tos']
      end
    ...
    def list_invalid_properties
      ...
      if @collector_profile.nil?
        invalid_properties.push('invalid value for "collector_profile", collector_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['IpfixSwitchUpmProfile'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @priority.nil?
      return false if @priority > 65536
      return false if @priority < 0
      return false if @collector_profile.nil?
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['IpfixSwitchUpmProfile'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          priority == o.priority &&
          collector_profile == o.collector_profile &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, priority, collector_profile, idle_timeout, max_flows, observation_domain_id, active_timeout, applied_tos, packet_sample_probability].hash
    end
