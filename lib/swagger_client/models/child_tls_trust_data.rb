...
module SwaggerClient
  ...
  class ChildTlsTrustData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TlsTrustData')
        self.tls_trust_data = attributes[:'TlsTrustData']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tls_trust_data.nil?
        invalid_properties.push('invalid value for "tls_trust_data", tls_trust_data cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tls_trust_data.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tls_trust_data == o.tls_trust_data
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, tls_trust_data].hash
    end
