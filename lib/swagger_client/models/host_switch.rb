...
module SwaggerClient
  ...
  class HostSwitch
    ...
    attr_accessor :static_ip_pool_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'static_ip_pool_id')
        self.static_ip_pool_id = attributes[:'static_ip_pool_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          static_ip_pool_id == o.static_ip_pool_id &&
    ...
    def hash
      [pnics, host_switch_name, static_ip_pool_id, host_switch_profile_ids].hash
    end
