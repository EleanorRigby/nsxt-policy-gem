  ...
  class RealizedServices
    ...
    def self.swagger_types
      {
        ...
        :'realized_services' => :'Array<RealizedService>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'realized_services')
        if (value = attributes[:'realized_services']).is_a?(Array)
          self.realized_services = value
        end
      end
    end
