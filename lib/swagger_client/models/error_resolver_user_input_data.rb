...
module SwaggerClient
  ...
  class ErrorResolverUserInputData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'property_value')
    ...
    def valid?
      ...
      data_type_validator = EnumAttributeValidator.new('String', ['TEXT', 'NUMBER', 'PASSWORD'])
    ...
    def data_type=(data_type)
      validator = EnumAttributeValidator.new('String', ['TEXT', 'NUMBER', 'PASSWORD'])
    ...
    def hash
      [data_type, property_name, property_value].hash
    end
