...
module SwaggerClient
  ...
  class ChildPolicyServiceChain
    ...
    attr_accessor :policy_service_chain
    ...
    def self.attribute_map
      {
        ...
        :'policy_service_chain' => :'PolicyServiceChain'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyServiceChain')
        self.policy_service_chain = attributes[:'PolicyServiceChain']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_service_chain.nil?
        invalid_properties.push('invalid value for "policy_service_chain", policy_service_chain cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_service_chain.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_service_chain == o.policy_service_chain
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_service_chain].hash
    end
