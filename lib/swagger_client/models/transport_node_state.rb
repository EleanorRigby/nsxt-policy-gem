...
module SwaggerClient
  ...
  class TransportNodeState
    ...
    def valid?
      state_validator = EnumAttributeValidator.new('String', ['pending', 'in_progress', 'success', 'failed', 'partial_success', 'orphaned', 'unknown'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['pending', 'in_progress', 'success', 'failed', 'partial_success', 'orphaned', 'unknown'])
    ...
    def hash
      [state, details, failure_code, failure_message, node_deployment_state, host_switch_states, maintenance_mode_state, transport_node_id].hash
    end
