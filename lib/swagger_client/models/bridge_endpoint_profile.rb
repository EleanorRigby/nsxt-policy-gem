  ...
  class BridgeEndpointProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'high_availability_mode')
        ...
        self.high_availability_mode = 'ACTIVE_STANDBY'
      end
    ...
    def list_invalid_properties
      ...
      if @edge_cluster_id.to_s.length > 36
        invalid_properties.push('invalid value for "edge_cluster_id", the character length must be smaller than or equal to 36.')
      end
    ...
    def valid?
      ...
      high_availability_mode_validator = EnumAttributeValidator.new('String', ['ACTIVE_STANDBY'])
      return false unless high_availability_mode_validator.valid?(@high_availability_mode)
      return false if @edge_cluster_id.nil?
      return false if @edge_cluster_id.to_s.length > 36
      true
    end
    ...
    def high_availability_mode=(high_availability_mode)
      validator = EnumAttributeValidator.new('String', ['ACTIVE_STANDBY'])
    ...
    # Custom attribute writer method with validation
    # @param [Object] edge_cluster_id Value to be assigned
    def edge_cluster_id=(edge_cluster_id)
      if edge_cluster_id.nil?
        fail ArgumentError, 'edge_cluster_id cannot be nil'
      end

      if edge_cluster_id.to_s.length > 36
        fail ArgumentError, 'invalid value for "edge_cluster_id", the character length must be smaller than or equal to 36.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, failover_mode, edge_cluster_member_indexes, high_availability_mode, edge_cluster_id].hash
    end
