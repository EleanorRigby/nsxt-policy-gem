...
module SwaggerClient
  ...
  class ChildL2Vpn
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'L2Vpn')
        self.l2_vpn = attributes[:'L2Vpn']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @l2_vpn.nil?
        invalid_properties.push('invalid value for "l2_vpn", l2_vpn cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, l2_vpn].hash
    end
