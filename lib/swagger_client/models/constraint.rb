...
module SwaggerClient
  ...
  class Constraint
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'constraint_expression')
        self.constraint_expression = attributes[:'constraint_expression']
      end
    ...
    def list_invalid_properties
      ...
      if @constraint_expression.nil?
        invalid_properties.push('invalid value for "constraint_expression", constraint_expression cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @constraint_expression.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          message == o.message &&
          constraint_expression == o.constraint_expression &&
          target == o.target
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, message, constraint_expression, target].hash
    end
