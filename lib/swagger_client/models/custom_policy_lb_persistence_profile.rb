...
module SwaggerClient
  ...
  class CustomPolicyLbPersistenceProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'persistence')
        self.persistence = attributes[:'persistence']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @persistence.nil?
        invalid_properties.push('invalid value for "persistence", persistence cannot be nil.')
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['L4PolicyLbPersistenceProfile', 'L7PolicyLbPersistenceProfile', 'CustomPolicyLbPersistenceProfile'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @persistence.nil?
      persistence_validator = EnumAttributeValidator.new('String', ['COOKIE', 'SOURCE_IP'])
      return false unless persistence_validator.valid?(@persistence)
      true
    end
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['L4PolicyLbPersistenceProfile', 'L7PolicyLbPersistenceProfile', 'CustomPolicyLbPersistenceProfile'])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] persistence Object to be assigned
    def persistence=(persistence)
      validator = EnumAttributeValidator.new('String', ['COOKIE', 'SOURCE_IP'])
      unless validator.valid?(persistence)
        fail ArgumentError, 'invalid value for "persistence", must be one of #{validator.allowable_values}.'
      end
      @persistence = persistence
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, persistence_shared, persistence].hash
    end
