...
module SwaggerClient
  ...
  class GroupInfo
    ...
    attr_accessor :group_policy_path

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'group' => :'group',
        :'group_policy_path' => :'group_policy_path'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'group_policy_path')
        self.group_policy_path = attributes[:'group_policy_path']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          group == o.group &&
          group_policy_path == o.group_policy_path
    end
