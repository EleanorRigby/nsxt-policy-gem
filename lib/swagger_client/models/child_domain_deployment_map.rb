...
module SwaggerClient
  ...
  class ChildDomainDeploymentMap
    ...
    attr_accessor :domain_deployment_map
    ...
    def self.attribute_map
      {
        ...
        :'domain_deployment_map' => :'DomainDeploymentMap'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DomainDeploymentMap')
        self.domain_deployment_map = attributes[:'DomainDeploymentMap']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @domain_deployment_map.nil?
        invalid_properties.push('invalid value for "domain_deployment_map", domain_deployment_map cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @domain_deployment_map.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          domain_deployment_map == o.domain_deployment_map
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, domain_deployment_map].hash
    end
