...
module SwaggerClient
  class UnassociatedVMListResult
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, last_update_timestamp, results].hash
    end
