...
module SwaggerClient
  ...
  class ChildTier1Interface
    ...
    def self.attribute_map
      {
        ...
        :'tier1_interface' => :'Tier1Interface'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Tier1Interface')
        self.tier1_interface = attributes[:'Tier1Interface']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tier1_interface.nil?
        invalid_properties.push('invalid value for "tier1_interface", tier1_interface cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tier1_interface.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tier1_interface == o.tier1_interface
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, tier1_interface].hash
    end
