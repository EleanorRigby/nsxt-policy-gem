...
module SwaggerClient
  ...
  class IdfwTransportNodeCondition
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'UP', 'DOWN', 'NOT_PREPARED', 'IDFW_COMPONENT_NOT_INSTALLED', 'DFW_DISABLED', 'IDFW_DISABLED'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'UP', 'DOWN', 'NOT_PREPARED', 'IDFW_COMPONENT_NOT_INSTALLED', 'DFW_DISABLED', 'IDFW_DISABLED'])
