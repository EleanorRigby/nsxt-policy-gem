...
module SwaggerClient
  class ConditionalForwarderZone
    ...
    def list_invalid_properties
      ...
      if @domain_names.nil?
        invalid_properties.push('invalid value for "domain_names", domain_names cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @domain_names.nil?
      true
    end
    ...
    def hash
      [upstream_servers, source_ip, domain_names].hash
    end
