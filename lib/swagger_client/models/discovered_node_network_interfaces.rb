...
module SwaggerClient
  ...
  class DiscoveredNodeNetworkInterfaces
    ...
    def self.swagger_types
      {
        ...
        :'network_interfaces' => :'Array<DiscoveredNodeInterfaceProperties>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'network_interfaces')
    ...
    def list_invalid_properties
      ...
      if @discovered_node_id.nil?
        invalid_properties.push('invalid value for "discovered_node_id", discovered_node_id cannot be nil.')
      end
    ...
    def valid?
      return false if @discovered_node_id.nil?
      true
    end
    ...
    def hash
      [discovered_node_id, network_interfaces].hash
    end
