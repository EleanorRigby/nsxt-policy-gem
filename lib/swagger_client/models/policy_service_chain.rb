...
module SwaggerClient
  ...
  class PolicyServiceChain
    ...
    attr_accessor :service_segment_path
    ...
    def self.attribute_map
      {
        ...
        :'service_segment_path' => :'service_segment_path',
    ...
    def self.swagger_types
      {
        ...
        :'reverse_path_service_profiles' => :'Array<String>',
        :'path_selection_policy' => :'String',
        :'service_segment_path' => :'Array<String>',
        :'forward_path_service_profiles' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reverse_path_service_profiles')
        if (value = attributes[:'reverse_path_service_profiles']).is_a?(Array)
          self.reverse_path_service_profiles = value
        end
      end

      if attributes.has_key?(:'path_selection_policy')
        self.path_selection_policy = attributes[:'path_selection_policy']
      else
        self.path_selection_policy = 'ANY'
      end

      if attributes.has_key?(:'service_segment_path')
        if (value = attributes[:'service_segment_path']).is_a?(Array)
          self.service_segment_path = value
        end
      end

      if attributes.has_key?(:'forward_path_service_profiles')
    ...
    def list_invalid_properties
      ...
      if @service_segment_path.nil?
        invalid_properties.push('invalid value for "service_segment_path", service_segment_path cannot be nil.')
      end
    ...
    def valid?
      ...
      path_selection_policy_validator = EnumAttributeValidator.new('String', ['ANY', 'LOCAL', 'REMOTE', 'ROUND_ROBIN'])
      return false unless path_selection_policy_validator.valid?(@path_selection_policy)
      return false if @service_segment_path.nil?
    ...
    def path_selection_policy=(path_selection_policy)
      validator = EnumAttributeValidator.new('String', ['ANY', 'LOCAL', 'REMOTE', 'ROUND_ROBIN'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_segment_path == o.service_segment_path &&
