...
module SwaggerClient
  class TraceflowObservationCounters
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'forwarded_count')
        self.forwarded_count = attributes[:'forwarded_count']
      end

      if attributes.has_key?(:'dropped_count')
        self.dropped_count = attributes[:'dropped_count']
      end
      ...
      if attributes.has_key?(:'received_count')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          forwarded_count == o.forwarded_count &&
    ...
    def hash
      [forwarded_count, dropped_count, delivered_count, received_count].hash
    end
