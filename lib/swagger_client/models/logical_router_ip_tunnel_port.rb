...
module SwaggerClient
  ...
  class LogicalRouterIPTunnelPort
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vpn_session_id')
        self.vpn_session_id = attributes[:'vpn_session_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vpn_session_id == o.vpn_session_id
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, logical_router_id, service_bindings, subnets, admin_state, vpn_session_id].hash
    end
