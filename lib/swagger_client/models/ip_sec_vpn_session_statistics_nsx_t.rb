...
module SwaggerClient
  ...
  class IPSecVpnSessionStatisticsNsxT
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['IPSecVpnSessionStatisticsNsxT'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['IPSecVpnSessionStatisticsNsxT'])
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, last_update_timestamp, ike_traffic_statistics, ike_status, policy_statistics, aggregate_traffic_counters].hash
    end
