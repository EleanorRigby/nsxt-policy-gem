...
module SwaggerClient
  ...
  class ChildSegmentPort
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SegmentPort')
        self.segment_port = attributes[:'SegmentPort']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @segment_port.nil?
        invalid_properties.push('invalid value for "segment_port", segment_port cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @segment_port.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, segment_port].hash
    end
