...
module SwaggerClient
  ...
  class PolicyNatRuleStatisticsPerEnforcementPoint
    # Gives NAT rule stats on an enforcement point. 
    attr_accessor :rule_statistics
    ...
    def self.swagger_types
      {
        :'rule_statistics' => :'Array<PolicyNatRuleStatistics>',
        :'rule_path' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rule_statistics')
        if (value = attributes[:'rule_statistics']).is_a?(Array)
          self.rule_statistics = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          rule_statistics == o.rule_statistics &&
    ...
    def hash
      [rule_statistics, rule_path, enforcement_point_path].hash
    end
