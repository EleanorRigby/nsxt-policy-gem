...
module SwaggerClient
  ...
  class ChildSecurityPolicy
    ...
    def list_invalid_properties
      ...
      if @security_policy.nil?
        invalid_properties.push('invalid value for "security_policy", security_policy cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, security_policy].hash
    end
