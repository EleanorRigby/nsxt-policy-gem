...
module SwaggerClient
  ...
  class LBPassiveMonitorProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_fails')
        self.max_fails = attributes[:'max_fails']
      else
        self.max_fails = 5
      end
    ...
    def list_invalid_properties
      ...
      if !@max_fails.nil? && @max_fails > 2147483647
        invalid_properties.push('invalid value for "max_fails", must be smaller than or equal to 2147483647.')
      end

      if !@max_fails.nil? && @max_fails < 1
        invalid_properties.push('invalid value for "max_fails", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@max_fails.nil? && @max_fails > 2147483647
      return false if !@max_fails.nil? && @max_fails < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] max_fails Value to be assigned
    def max_fails=(max_fails)
      if !max_fails.nil? && max_fails > 2147483647
        fail ArgumentError, 'invalid value for "max_fails", must be smaller than or equal to 2147483647.'
      end

      if !max_fails.nil? && max_fails < 1
        fail ArgumentError, 'invalid value for "max_fails", must be greater than or equal to 1.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, max_fails, timeout].hash
    end
