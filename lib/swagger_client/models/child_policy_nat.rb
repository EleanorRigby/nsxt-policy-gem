...
module SwaggerClient
  ...
  class ChildPolicyNat
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyNat')
        self.policy_nat = attributes[:'PolicyNat']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_nat.nil?
        invalid_properties.push('invalid value for "policy_nat", policy_nat cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_nat.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_nat].hash
    end
