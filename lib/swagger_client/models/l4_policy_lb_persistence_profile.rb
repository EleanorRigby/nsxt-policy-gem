...
module SwaggerClient
  ...
  class L4PolicyLbPersistenceProfile
    ...
    def valid?
      ...
      persistence_validator = EnumAttributeValidator.new('String', ['SOURCE_IP'])
    ...
    def persistence=(persistence)
      validator = EnumAttributeValidator.new('String', ['SOURCE_IP'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, persistence].hash
    end
