...
module SwaggerClient
  class Csr
    ...
    def valid?
      ...
      algorithm_validator = EnumAttributeValidator.new('String', ['RSA', 'DSA'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, key_size, pem_encoded, algorithm, subject].hash
    end
