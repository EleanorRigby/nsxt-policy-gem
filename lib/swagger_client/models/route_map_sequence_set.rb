...
module SwaggerClient
  class RouteMapSequenceSet
    ...
    def list_invalid_properties
      ...
      if !@local_preference.nil? && @local_preference < 0
        invalid_properties.push('invalid value for "local_preference", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@local_preference.nil? && @local_preference < 0
    ...
    def local_preference=(local_preference)
      ...
      if !local_preference.nil? && local_preference < 0
        fail ArgumentError, 'invalid value for "local_preference", must be greater than or equal to 0.'
      end
    ...
    def hash
      [local_preference, as_path_prepend, community, weight, multi_exit_discriminator].hash
    end
