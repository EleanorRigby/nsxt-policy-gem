...
module SwaggerClient
  ...
  class LogicalPortAttachment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'attachment_type')
        self.attachment_type = attributes[:'attachment_type']
      else
        self.attachment_type = 'VIF'
      end
    ...
    def valid?
      attachment_type_validator = EnumAttributeValidator.new('String', ['VIF', 'LOGICALROUTER', 'BRIDGEENDPOINT', 'DHCP_SERVICE', 'METADATA_PROXY', 'L2VPN_SESSION'])
    ...
    def hash
      [attachment_type, context, id].hash
    end
