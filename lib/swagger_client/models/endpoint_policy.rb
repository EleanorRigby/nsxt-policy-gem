...
module SwaggerClient
  ...
  class EndpointPolicy
    ...
    def self.swagger_types
      {
        ...
        :'endpoint_rules' => :'Array<EndpointRule>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'endpoint_rules')
        if (value = attributes[:'endpoint_rules']).is_a?(Array)
          self.endpoint_rules = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          endpoint_rules == o.endpoint_rules &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, endpoint_rules, sequence_number].hash
    end
