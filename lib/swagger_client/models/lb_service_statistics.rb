...
module SwaggerClient
  class LBServiceStatistics
    ...
    def self.swagger_types
      {
        ...
        :'pools' => :'Array<LBPoolStatistics>',
        :'last_update_timestamp' => :'Integer',
        :'virtual_servers' => :'Array<LBVirtualServerStatistics>',
        :'service_path' => :'String',
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, pools, last_update_timestamp, virtual_servers, service_path, statistics].hash
    end
