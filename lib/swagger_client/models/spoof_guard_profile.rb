...
module SwaggerClient
  ...
  class SpoofGuardProfile
    ...
    attr_accessor :address_binding_whitelist
    ...
    def self.swagger_types
      {
        ...
        :'address_binding_whitelist' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'address_binding_whitelist')
        self.address_binding_whitelist = attributes[:'address_binding_whitelist']
      else
        self.address_binding_whitelist = false
      end
    end
    ...
    def list_invalid_properties
      ...
      if @address_binding_whitelist.nil?
        invalid_properties.push('invalid value for "address_binding_whitelist", address_binding_whitelist cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @address_binding_whitelist.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          address_binding_whitelist == o.address_binding_whitelist
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, address_binding_whitelist].hash
    end
