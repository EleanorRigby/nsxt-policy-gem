...
module SwaggerClient
  ...
  class ChildLocaleServices
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LocaleServices')
        self.locale_services = attributes[:'LocaleServices']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @locale_services.nil?
        invalid_properties.push('invalid value for "locale_services", locale_services cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @locale_services.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          locale_services == o.locale_services
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, locale_services].hash
    end
