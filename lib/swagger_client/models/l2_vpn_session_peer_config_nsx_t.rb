...
module SwaggerClient
  ...
  class L2VPNSessionPeerConfigNsxT
    ...
    def self.swagger_types
      {
        ...
        :'peer_codes' => :'Array<L2VPNSessionTransportTunnelPeerCode>'
      }
    end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['L2VPNSessionPeerConfigNsxT'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['L2VPNSessionPeerConfigNsxT'])
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, peer_codes].hash
    end
