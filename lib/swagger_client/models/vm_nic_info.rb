...
module SwaggerClient
  ...
  class VmNicInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nic_infos')
        if (value = attributes[:'nic_infos']).is_a?(Array)
          self.nic_infos = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @nic_infos.nil?
        invalid_properties.push('invalid value for "nic_infos", nic_infos cannot be nil.')
      end
