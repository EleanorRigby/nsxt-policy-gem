...
module SwaggerClient
  ...
  class NotificationAuthenticationScheme
    ...
    def valid?
      ...
      scheme_name_validator = EnumAttributeValidator.new('String', ['BASIC_AUTH', 'CERTIFICATE'])
      return false unless scheme_name_validator.valid?(@scheme_name)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] scheme_name Object to be assigned
    def scheme_name=(scheme_name)
      validator = EnumAttributeValidator.new('String', ['BASIC_AUTH', 'CERTIFICATE'])
      unless validator.valid?(scheme_name)
        fail ArgumentError, 'invalid value for "scheme_name", must be one of #{validator.allowable_values}.'
      end
      @scheme_name = scheme_name
    end
    ...
    def hash
      [username, certificate_id, scheme_name, password].hash
    end
