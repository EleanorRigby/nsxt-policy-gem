...
module SwaggerClient
  ...
  class IPSecVPNPolicyRule
    ...
    def self.swagger_types
      {
        ...
        :'description' => :'String',
        :'sources' => :'Array<IPSecVPNPolicySubnet>',
        :'action' => :'String',
        :'enabled' => :'BOOLEAN',
        :'logged' => :'BOOLEAN',
        :'destinations' => :'Array<IPSecVPNPolicySubnet>'
      }
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _owner, display_name, id, resource_type, description, sources, action, enabled, logged, destinations].hash
    end
