...
module SwaggerClient
  ...
  class ChildRedirectionRule
    ...
    attr_accessor :redirection_rule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RedirectionRule')
        self.redirection_rule = attributes[:'RedirectionRule']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @redirection_rule.nil?
        invalid_properties.push('invalid value for "redirection_rule", redirection_rule cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @redirection_rule.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          redirection_rule == o.redirection_rule
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, redirection_rule].hash
    end
