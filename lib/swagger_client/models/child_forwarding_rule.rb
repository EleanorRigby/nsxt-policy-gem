...
module SwaggerClient
  ...
  class ChildForwardingRule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ForwardingRule')
        self.forwarding_rule = attributes[:'ForwardingRule']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @forwarding_rule.nil?
        invalid_properties.push('invalid value for "forwarding_rule", forwarding_rule cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @forwarding_rule.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          forwarding_rule == o.forwarding_rule
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, forwarding_rule].hash
    end
