...
module SwaggerClient
  ...
  class ChildDeploymentZone
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DeploymentZone')
        self.deployment_zone = attributes[:'DeploymentZone']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @deployment_zone.nil?
        invalid_properties.push('invalid value for "deployment_zone", deployment_zone cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @deployment_zone.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deployment_zone == o.deployment_zone
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, deployment_zone].hash
    end
