...
module SwaggerClient
  ...
  class PolicyNatRuleStatistics
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'warning_message')
    ...
    def hash
      [total_packets, active_sessions, total_bytes, last_update_timestamp, warning_message].hash
    end
