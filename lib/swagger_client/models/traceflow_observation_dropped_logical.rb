...
module SwaggerClient
  class TraceflowObservationDroppedLogical
    ...
    def valid?
      ...
      reason_validator = EnumAttributeValidator.new('String', ['ARP_FAIL', 'BFD', 'DHCP', 'FW_RULE', 'GENEVE', 'GRE', 'IFACE', 'IP', 'IP_REASS', 'IPSEC', 'IPSEC_VTI', 'L2VPN', 'L4PORT', 'LB', 'LROUTER', 'LSERVICE', 'LSWITCH', 'MD_PROXY', 'NAT', 'NEIGH', 'NO_ROUTE', 'SERVICE_INSERT', 'TTL_ZERO', 'TUNNEL', 'VXLAN', 'VXSTT', 'VMC_NO_RESPONSE', 'UNKNOWN'])
    ...
    def reason=(reason)
      validator = EnumAttributeValidator.new('String', ['ARP_FAIL', 'BFD', 'DHCP', 'FW_RULE', 'GENEVE', 'GRE', 'IFACE', 'IP', 'IP_REASS', 'IPSEC', 'IPSEC_VTI', 'L2VPN', 'L4PORT', 'LB', 'LROUTER', 'LSERVICE', 'LSWITCH', 'MD_PROXY', 'NAT', 'NEIGH', 'NO_ROUTE', 'SERVICE_INSERT', 'TTL_ZERO', 'TUNNEL', 'VXLAN', 'VXSTT', 'VMC_NO_RESPONSE', 'UNKNOWN'])
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, reason, lport_name, acl_rule_id, lport_id, component_id].hash
    end
