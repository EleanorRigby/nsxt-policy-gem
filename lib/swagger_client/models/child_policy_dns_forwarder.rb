...
module SwaggerClient
  ...
  class ChildPolicyDnsForwarder
    ...
    attr_accessor :policy_dns_forwarder
    ...
    def self.attribute_map
      {
        ...
        :'policy_dns_forwarder' => :'PolicyDnsForwarder'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyDnsForwarder')
        self.policy_dns_forwarder = attributes[:'PolicyDnsForwarder']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_dns_forwarder.nil?
        invalid_properties.push('invalid value for "policy_dns_forwarder", policy_dns_forwarder cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_dns_forwarder.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_dns_forwarder == o.policy_dns_forwarder
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, policy_dns_forwarder].hash
    end
