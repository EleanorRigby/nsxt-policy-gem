...
module SwaggerClient
  ...
  class ServiceDefinition
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, service_deployment_spec, functionalities, attachment_point, service_manager_id, vendor_id, on_failure_policy, transports, implementations].hash
    end
