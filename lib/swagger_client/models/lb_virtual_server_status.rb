...
module SwaggerClient
  class LBVirtualServerStatus
    ...
    attr_accessor :virtual_server_path
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'virtual_server_path')
        self.virtual_server_path = attributes[:'virtual_server_path']
      end
    end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['UP', 'PARTIALLY_UP', 'PRIMARY_DOWN', 'DOWN', 'DETACHED', 'DISABLED', 'UNKNOWN'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['UP', 'PARTIALLY_UP', 'PRIMARY_DOWN', 'DOWN', 'DETACHED', 'DISABLED', 'UNKNOWN'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          virtual_server_path == o.virtual_server_path
    end
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, status, last_update_timestamp, virtual_server_path].hash
    end
