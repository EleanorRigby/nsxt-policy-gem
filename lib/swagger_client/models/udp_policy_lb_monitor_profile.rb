...
module SwaggerClient
  ...
  class UdpPolicyLbMonitorProfile
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['TcpPolicyLbMonitorProfile', 'UdpPolicyLbMonitorProfile', 'IcmpPolicyLbMonitorProfile', 'HttpPolicyLbMonitorProfile', 'HttpsPolicyLbMonitorProfile'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['TcpPolicyLbMonitorProfile', 'UdpPolicyLbMonitorProfile', 'IcmpPolicyLbMonitorProfile', 'HttpPolicyLbMonitorProfile', 'HttpsPolicyLbMonitorProfile'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, monitor_port, timeout, fall_count, interval, rise_count, receive, send].hash
    end
