...
module SwaggerClient
  ...
  class PolicyTransportZone
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tz_type')
        self.tz_type = attributes[:'tz_type']
      end

      if attributes.has_key?(:'nsx_id')
        self.nsx_id = attributes[:'nsx_id']
      end
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, is_default, tz_type, nsx_id].hash
    end
