...
module SwaggerClient
  ...
  class LBCookiePersistenceProfile
    ...
    def valid?
      ...
      cookie_mode_validator = EnumAttributeValidator.new('String', ['INSERT', 'PREFIX', 'REWRITE'])
    ...
    def cookie_mode=(cookie_mode)
      validator = EnumAttributeValidator.new('String', ['INSERT', 'PREFIX', 'REWRITE'])
