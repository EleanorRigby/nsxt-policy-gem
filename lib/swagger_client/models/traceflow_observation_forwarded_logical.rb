...
module SwaggerClient
  class TraceflowObservationForwardedLogical
    ...
    def valid?
      ...
      dst_component_type_validator = EnumAttributeValidator.new('String', ['PHYSICAL', 'LR', 'LS', 'DFW', 'BRIDGE', 'EDGE_TUNNEL', 'EDGE_HOSTSWITCH', 'FW_BRIDGE', 'LOAD_BALANCER', 'NAT', 'IPSEC', 'SERVICE_INSERTION', 'UNKNOWN'])
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, service_path_index, component_id, lport_name, acl_rule_id, service_index, vni, dst_component_name, dst_component_id, dst_component_type, lport_id, service_ttl].hash
    end
