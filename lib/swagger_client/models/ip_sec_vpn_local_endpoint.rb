...
module SwaggerClient
  # Local endpoint represents a tier-0 on which tunnel needs to be terminated.
  class IPSecVpnLocalEndpoint
    ...
    def self.attribute_map
      {
        ...
        :'trust_ca_paths' => :'trust_ca_paths',
        :'local_id' => :'local_id',
        :'trust_crl_paths' => :'trust_crl_paths',
    ...
    def self.swagger_types
      {
        ...
        :'trust_ca_paths' => :'Array<String>',
        :'local_id' => :'String',
        :'trust_crl_paths' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'trust_ca_paths')
        if (value = attributes[:'trust_ca_paths']).is_a?(Array)
          self.trust_ca_paths = value
        end
      end
      ...
      if attributes.has_key?(:'trust_crl_paths')
        if (value = attributes[:'trust_crl_paths']).is_a?(Array)
          self.trust_crl_paths = value
        end
      end

      if attributes.has_key?(:'certificate_path')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          trust_ca_paths == o.trust_ca_paths &&
          local_id == o.local_id &&
          trust_crl_paths == o.trust_crl_paths &&
