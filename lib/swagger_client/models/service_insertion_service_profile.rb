...
module SwaggerClient
  ...
  class ServiceInsertionServiceProfile
    ...
    attr_accessor :vendor_template_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vendor_template_id')
        self.vendor_template_id = attributes[:'vendor_template_id']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vendor_template_id.nil?
        invalid_properties.push('invalid value for "vendor_template_id", vendor_template_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vendor_template_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vendor_template_id == o.vendor_template_id
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, attributes, service_id, redirection_action, vendor_template_id].hash
    end
