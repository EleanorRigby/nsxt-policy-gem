...
module SwaggerClient
  ...
  class ChildEndpointPolicy
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'EndpointPolicy')
        self.endpoint_policy = attributes[:'EndpointPolicy']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @endpoint_policy.nil?
        invalid_properties.push('invalid value for "endpoint_policy", endpoint_policy cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @endpoint_policy.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          endpoint_policy == o.endpoint_policy
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, endpoint_policy].hash
    end
