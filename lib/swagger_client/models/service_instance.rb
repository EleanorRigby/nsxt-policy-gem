...
module SwaggerClient
  ...
  class ServiceInstance
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'service_deployment_id')
    ...
    def valid?
      ...
      transport_type_validator = EnumAttributeValidator.new('String', ['L2_BRIDGE', 'L3_ROUTED', 'NSH', 'NA'])
      ...
      attachment_point_validator = EnumAttributeValidator.new('String', ['TIER0_LR', 'TIER1_LR', 'SERVICE_PLANE', 'HOST'])
    ...
    def transport_type=(transport_type)
      validator = EnumAttributeValidator.new('String', ['L2_BRIDGE', 'L3_ROUTED', 'NSH', 'NA'])
    ...
    def attachment_point=(attachment_point)
      validator = EnumAttributeValidator.new('String', ['TIER0_LR', 'TIER1_LR', 'SERVICE_PLANE', 'HOST'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_deployment_id == o.service_deployment_id
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, on_failure_policy, transport_type, service_id, deployment_spec_name, instance_deployment_template, implementation_type, attachment_point, instance_deployment_config, deployment_mode, deployed_to, service_deployment_id].hash
    end
