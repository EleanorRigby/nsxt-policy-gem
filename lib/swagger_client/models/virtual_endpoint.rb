...
module SwaggerClient
  ...
  class VirtualEndpoint
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'service_names')
        if (value = attributes[:'service_names']).is_a?(Array)
          self.service_names = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @service_names.nil?
        invalid_properties.push('invalid value for "service_names", service_names cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @service_names.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, target_ips, service_names].hash
    end
