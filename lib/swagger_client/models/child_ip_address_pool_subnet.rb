...
module SwaggerClient
  ...
  class ChildIpAddressPoolSubnet
    ...
    attr_accessor :ip_address_pool_subnet
    ...
    def self.attribute_map
      {
        ...
        :'ip_address_pool_subnet' => :'IpAddressPoolSubnet'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IpAddressPoolSubnet')
        self.ip_address_pool_subnet = attributes[:'IpAddressPoolSubnet']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ip_address_pool_subnet.nil?
        invalid_properties.push('invalid value for "ip_address_pool_subnet", ip_address_pool_subnet cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ip_address_pool_subnet.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ip_address_pool_subnet == o.ip_address_pool_subnet
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, ip_address_pool_subnet].hash
    end
