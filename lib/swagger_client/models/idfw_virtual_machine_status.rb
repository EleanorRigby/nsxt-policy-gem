...
module SwaggerClient
  ...
  class IdfwVirtualMachineStatus
    ...
    def self.swagger_types
      {
        :'vm_status' => :'Array<IdfwVirtualMachineCondition>',
        :'vm_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vm_status')
        if (value = attributes[:'vm_status']).is_a?(Array)
          self.vm_status = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @vm_status.nil?
        invalid_properties.push('invalid value for "vm_status", vm_status cannot be nil.')
      end
