...
module SwaggerClient
  ...
  class PolicyLbRule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'path_match')
        self.path_match = attributes[:'path_match']
      end

      if attributes.has_key?(:'host_match')
        self.host_match = attributes[:'host_match']
      end

      if attributes.has_key?(:'lb_virtual_server')
        self.lb_virtual_server = attributes[:'lb_virtual_server']
      end
