...
module SwaggerClient
  ...
  class ChildForwardingPolicy
    ...
    attr_accessor :forwarding_policy
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ForwardingPolicy')
        self.forwarding_policy = attributes[:'ForwardingPolicy']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @forwarding_policy.nil?
        invalid_properties.push('invalid value for "forwarding_policy", forwarding_policy cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @forwarding_policy.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          forwarding_policy == o.forwarding_policy
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, forwarding_policy].hash
    end
