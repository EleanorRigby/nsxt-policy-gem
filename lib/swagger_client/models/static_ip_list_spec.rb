...
module SwaggerClient
  ...
  class StaticIpListSpec
    ...
    def list_invalid_properties
      ...
      if @ip_list.nil?
        invalid_properties.push('invalid value for "ip_list", ip_list cannot be nil.')
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['StaticIpPoolSpec', 'StaticIpListSpec', 'AssignedByDhcp', 'StaticIpMacListSpec'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @subnet_mask.nil?
      return false if @ip_list.nil?
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['StaticIpPoolSpec', 'StaticIpListSpec', 'AssignedByDhcp', 'StaticIpMacListSpec'])
    ...
    def hash
      [resource_type, subnet_mask, ip_list, default_gateway].hash
    end
