...
module SwaggerClient
  ...
  class ChildTier0RouteMap
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Tier0RouteMap')
        self.tier0_route_map = attributes[:'Tier0RouteMap']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tier0_route_map.nil?
        invalid_properties.push('invalid value for "tier0_route_map", tier0_route_map cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tier0_route_map.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tier0_route_map == o.tier0_route_map
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, tier0_route_map].hash
    end
