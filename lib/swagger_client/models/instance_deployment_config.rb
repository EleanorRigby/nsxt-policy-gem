...
module SwaggerClient
  ...
  class InstanceDeploymentConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vm_nic_infos')
        if (value = attributes[:'vm_nic_infos']).is_a?(Array)
          self.vm_nic_infos = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @vm_nic_infos.nil?
        invalid_properties.push('invalid value for "vm_nic_infos", vm_nic_infos cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vm_nic_infos.nil?
    ...
    def hash
      [context_id, vm_nic_infos, storage_id, host_id, compute_id].hash
    end
