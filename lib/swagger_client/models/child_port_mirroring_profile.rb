...
module SwaggerClient
  ...
  class ChildPortMirroringProfile
    ...
    attr_accessor :port_mirroring_profile
    ...
    def self.attribute_map
      {
        ...
        :'port_mirroring_profile' => :'PortMirroringProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PortMirroringProfile')
        self.port_mirroring_profile = attributes[:'PortMirroringProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @port_mirroring_profile.nil?
        invalid_properties.push('invalid value for "port_mirroring_profile", port_mirroring_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @port_mirroring_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          port_mirroring_profile == o.port_mirroring_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, port_mirroring_profile].hash
    end
