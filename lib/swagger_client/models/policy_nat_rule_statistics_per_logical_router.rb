...
module SwaggerClient
  ...
  class PolicyNatRuleStatisticsPerLogicalRouter
    ...
    def self.swagger_types
      {
        ...
        :'per_node_statistics' => :'Array<PolicyNatRuleStatisticsPerTransportNode>',
    ...
    def hash
      [last_update_timestamp, per_node_statistics, statistics, router_path, enforcement_point_path].hash
    end
