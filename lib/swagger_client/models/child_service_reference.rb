...
module SwaggerClient
  ...
  class ChildServiceReference
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ServiceReference')
        self.service_reference = attributes[:'ServiceReference']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @service_reference.nil?
        invalid_properties.push('invalid value for "service_reference", service_reference cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @service_reference.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_reference == o.service_reference
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, service_reference].hash
    end
