...
module SwaggerClient
  ...
  class PrefixList
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'prefixes')
        if (value = attributes[:'prefixes']).is_a?(Array)
          self.prefixes = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @prefixes.nil?
        invalid_properties.push('invalid value for "prefixes", prefixes cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, prefixes].hash
    end
