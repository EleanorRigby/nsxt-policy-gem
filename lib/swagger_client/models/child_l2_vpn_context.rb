...
module SwaggerClient
  ...
  class ChildL2VpnContext
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'L2VpnContext')
        self.l2_vpn_context = attributes[:'L2VpnContext']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @l2_vpn_context.nil?
        invalid_properties.push('invalid value for "l2_vpn_context", l2_vpn_context cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @l2_vpn_context.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          l2_vpn_context == o.l2_vpn_context
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, l2_vpn_context].hash
    end
