...
module SwaggerClient
  ...
  class ServiceInstanceEndpoint
    ...
    attr_accessor :service_interface_path
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'target_ips')
        if (value = attributes[:'target_ips']).is_a?(Array)
          self.target_ips = value
        end
      end

      if attributes.has_key?(:'service_interface_path')
        self.service_interface_path = attributes[:'service_interface_path']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @service_interface_path.nil?
        invalid_properties.push('invalid value for "service_interface_path", service_interface_path cannot be nil.')
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['VirtualEndpoint', 'ServiceInstanceEndpoint'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @target_ips.nil?
      return false if @service_interface_path.nil?
      true
    end
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['VirtualEndpoint', 'ServiceInstanceEndpoint'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_interface_path == o.service_interface_path
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, target_ips, service_interface_path].hash
    end
