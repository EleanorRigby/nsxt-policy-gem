...
module SwaggerClient
  ...
  class IdentityGroupInfo
    # Each LDAP object is uniquely identified by its distinguished name (DN). A DN is a sequence of relative distinguished names (RDN) connected by commas. e.g. CN=Larry Cole,CN=admin,DC=corp,DC=acme,DC=com. 
    ...
    attr_accessor :domain_base_distinguished_name
    ...
    def self.attribute_map
      {
        ...
        :'domain_base_distinguished_name' => :'domain_base_distinguished_name',
        :'sid' => :'sid'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'distinguished_name')
        self.distinguished_name = attributes[:'distinguished_name']
      end

      if attributes.has_key?(:'domain_base_distinguished_name')
        self.domain_base_distinguished_name = attributes[:'domain_base_distinguished_name']
      end
    ...
    def list_invalid_properties
      ...
      if @domain_base_distinguished_name.nil?
        invalid_properties.push('invalid value for "domain_base_distinguished_name", domain_base_distinguished_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @domain_base_distinguished_name.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          domain_base_distinguished_name == o.domain_base_distinguished_name &&
          sid == o.sid
    end
    ...
    def hash
      [distinguished_name, domain_base_distinguished_name, sid].hash
    end
