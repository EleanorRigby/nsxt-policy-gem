...
module SwaggerClient
  ...
  class FileTransferProtocol
    ...
    def list_invalid_properties
      ...
      if @ssh_fingerprint.nil?
        invalid_properties.push('invalid value for "ssh_fingerprint", ssh_fingerprint cannot be nil.')
      end
    ...
    def valid?
      ...
      protocol_name_validator = EnumAttributeValidator.new('String', ['sftp'])
      return false unless protocol_name_validator.valid?(@protocol_name)
      return false if @ssh_fingerprint.nil?
      return false if @authentication_scheme.nil?
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] protocol_name Object to be assigned
    def protocol_name=(protocol_name)
      validator = EnumAttributeValidator.new('String', ['sftp'])
      unless validator.valid?(protocol_name)
        fail ArgumentError, 'invalid value for "protocol_name", must be one of #{validator.allowable_values}.'
      end
      @protocol_name = protocol_name
    end
    ...
    def hash
      [protocol_name, ssh_fingerprint, authentication_scheme].hash
    end
