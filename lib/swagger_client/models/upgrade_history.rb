...
module SwaggerClient
  class UpgradeHistory
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'initial_version')
    ...
    def list_invalid_properties
      ...
      if @target_version.nil?
        invalid_properties.push('invalid value for "target_version", target_version cannot be nil.')
      end

      if @initial_version.nil?
        invalid_properties.push('invalid value for "initial_version", initial_version cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @initial_version.nil?
      return false if @upgrade_status.nil?
      upgrade_status_validator = EnumAttributeValidator.new('String', ['STARTED', 'SUCCESS', 'FAILED'])
    ...
    def upgrade_status=(upgrade_status)
      validator = EnumAttributeValidator.new('String', ['STARTED', 'SUCCESS', 'FAILED'])
    ...
    def hash
      [timestamp, target_version, initial_version, upgrade_status].hash
    end
