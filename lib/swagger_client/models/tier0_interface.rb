...
module SwaggerClient
  ...
  class Tier0Interface
    ...
    # Specify association of interface with edge cluster member. This property is deprecated, use edge_path instead. Both properties cannot be used together. 
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['EXTERNAL', 'SERVICE'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['EXTERNAL', 'SERVICE'])
