...
module SwaggerClient
  class TraceflowObservationReceived
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, vtep_label, uplink_name, local_ip_address, remote_ip_address].hash
    end
