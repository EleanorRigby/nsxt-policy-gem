...
module SwaggerClient
  ...
  class LbVariableCondition
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'variable_value')
        self.variable_value = attributes[:'variable_value']
      end
    ...
    def list_invalid_properties
      ...
      if @variable_value.nil?
        invalid_properties.push('invalid value for "variable_value", variable_value cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @variable_value.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          inverse == o.inverse &&
          type == o.type &&
          variable_value == o.variable_value &&
    ...
    def hash
      [inverse, type, variable_value, case_sensitive, match_type, variable_name].hash
    end
