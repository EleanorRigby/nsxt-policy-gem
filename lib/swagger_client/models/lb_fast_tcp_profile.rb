...
module SwaggerClient
  ...
  class LBFastTcpProfile
    ...
    def self.swagger_types
      {
        ...
        :'ha_flow_mirroring_enabled' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'close_timeout')
      ...
      if attributes.has_key?(:'ha_flow_mirroring_enabled')
    ...
    def list_invalid_properties
      ...
      if !@close_timeout.nil? && @close_timeout > 60
        invalid_properties.push('invalid value for "close_timeout", must be smaller than or equal to 60.')
      end

      if !@close_timeout.nil? && @close_timeout < 1
        invalid_properties.push('invalid value for "close_timeout", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@close_timeout.nil? && @close_timeout > 60
      return false if !@close_timeout.nil? && @close_timeout < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] close_timeout Value to be assigned
    def close_timeout=(close_timeout)
      if !close_timeout.nil? && close_timeout > 60
        fail ArgumentError, 'invalid value for "close_timeout", must be smaller than or equal to 60.'
      end

      if !close_timeout.nil? && close_timeout < 1
        fail ArgumentError, 'invalid value for "close_timeout", must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ha_flow_mirroring_enabled == o.ha_flow_mirroring_enabled
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, close_timeout, idle_timeout, ha_flow_mirroring_enabled].hash
    end
