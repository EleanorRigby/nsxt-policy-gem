...
module SwaggerClient
  ...
  class ChildMacDiscoveryProfile
    ...
    attr_accessor :mac_discovery_profile
    ...
    def self.attribute_map
      {
        ...
        :'mac_discovery_profile' => :'MacDiscoveryProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'MacDiscoveryProfile')
        self.mac_discovery_profile = attributes[:'MacDiscoveryProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @mac_discovery_profile.nil?
        invalid_properties.push('invalid value for "mac_discovery_profile", mac_discovery_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @mac_discovery_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mac_discovery_profile == o.mac_discovery_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, mac_discovery_profile].hash
    end
