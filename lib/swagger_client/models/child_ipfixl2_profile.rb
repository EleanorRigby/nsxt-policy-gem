...
module SwaggerClient
  ...
  class ChildIPFIXL2Profile
    ...
    def self.attribute_map
      {
        ...
        :'ipfixl2_profile' => :'IPFIXL2Profile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IPFIXL2Profile')
        self.ipfixl2_profile = attributes[:'IPFIXL2Profile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ipfixl2_profile.nil?
        invalid_properties.push('invalid value for "ipfixl2_profile", ipfixl2_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ipfixl2_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ipfixl2_profile == o.ipfixl2_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, ipfixl2_profile].hash
    end
