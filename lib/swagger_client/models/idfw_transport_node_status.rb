...
module SwaggerClient
  ...
  class IdfwTransportNodeStatus
    ...
    attr_accessor :transport_node_status
    ...
    def self.swagger_types
      {
        :'transport_node_status' => :'Array<IdfwTransportNodeCondition>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transport_node_status')
        if (value = attributes[:'transport_node_status']).is_a?(Array)
          self.transport_node_status = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @transport_node_status.nil?
        invalid_properties.push('invalid value for "transport_node_status", transport_node_status cannot be nil.')
      end
    ...
    def valid?
      return false if @transport_node_status.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          transport_node_status == o.transport_node_status &&
    ...
    def hash
      [transport_node_status, transport_node_id].hash
    end
