...
module SwaggerClient
  class IPv4DhcpServer
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dhcp_server_ip')
    ...
    def list_invalid_properties
      ...
      if @dhcp_server_ip.nil?
        invalid_properties.push('invalid value for "dhcp_server_ip", dhcp_server_ip cannot be nil.')
      end
    ...
    def valid?
      return false if @dhcp_server_ip.nil?
      true
    end
    ...
    def hash
      [dhcp_server_ip, options, dns_nameservers, domain_name, gateway_ip].hash
    end
