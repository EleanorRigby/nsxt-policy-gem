...
module SwaggerClient
  ...
  class TargetResourceStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'target_status')
        self.target_status = attributes[:'target_status']
      end
    ...
    def list_invalid_properties
      ...
      if @target_status.nil?
        invalid_properties.push('invalid value for "target_status", target_status cannot be nil.')
      end
    ...
    def valid?
      ...
      target_status_validator = EnumAttributeValidator.new('String', ['DISABLED', 'ENABLED'])
      return false unless target_status_validator.valid?(@target_status)
      return false if !@target_id.nil? && @target_id.to_s.length > 64
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] target_status Object to be assigned
    def target_status=(target_status)
      validator = EnumAttributeValidator.new('String', ['DISABLED', 'ENABLED'])
      unless validator.valid?(target_status)
        fail ArgumentError, 'invalid value for "target_status", must be one of #{validator.allowable_values}.'
      end
      @target_status = target_status
    end
