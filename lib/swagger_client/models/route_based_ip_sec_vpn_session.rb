...
module SwaggerClient
  ...
  class RouteBasedIPSecVpnSession
    ...
    # Connection initiation mode used by local endpoint to establish ike connection with peer site. INITIATOR - In this mode local endpoint can initiate the process of tunnel creation. RESPOND_ONLY - In this mode remote site will always begin with the connection initiation request and local endpoint will respond to that connection request. ON_DEMAND - In this mode tunnel creation will begin once first packet matching the rule is received. 
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, psk, dpd_profile_path, ike_profile_path, enabled, connection_initiation_mode, local_endpoint_path, peer_address, tunnel_profile_path, authentication_mode, peer_id, force_whitelisting, tunnel_interfaces].hash
    end
