...
module SwaggerClient
  class LBPoolStatistics
    ...
    def self.swagger_types
      {
        ...
        :'pool_path' => :'String',
        :'members' => :'Array<LBPoolMemberStatistics>'
      }
    end
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, last_update_timestamp, statistics, pool_path, members].hash
    end
