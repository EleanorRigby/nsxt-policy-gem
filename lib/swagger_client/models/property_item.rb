...
module SwaggerClient
  ...
  class PropertyItem
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['String', 'Number', 'Date', 'Url'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['String', 'Number', 'Date', 'Url'])
    ...
    def hash
      [field, separator, render_configuration, type, heading, condition, label].hash
    end
