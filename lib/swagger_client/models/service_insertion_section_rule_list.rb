...
module SwaggerClient
  ...
  class ServiceInsertionSectionRuleList
    ...
    def self.swagger_types
      {
        ...
        :'rule_count' => :'Integer',
        :'section_type' => :'String',
        :'rules' => :'Array<ServiceInsertionRule>'
      }
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, stateful, is_default, applied_tos, rule_count, section_type, rules].hash
    end
