...
module SwaggerClient
  ...
  class LBFastUdpProfile
    ...
    attr_accessor :flow_mirroring_enabled
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'flow_mirroring_enabled')
        self.flow_mirroring_enabled = attributes[:'flow_mirroring_enabled']
      else
        self.flow_mirroring_enabled = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          flow_mirroring_enabled == o.flow_mirroring_enabled
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, idle_timeout, flow_mirroring_enabled].hash
    end
