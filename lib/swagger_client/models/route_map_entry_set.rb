...
module SwaggerClient
  ...
  class RouteMapEntrySet
    ...
    # Set BGP community for matching routes. Both well-known community name or community value in aa:nn (2byte:2byte) format are supported 
    ...
    def hash
      [med, local_preference, as_path_prepend, weight, community].hash
    end
