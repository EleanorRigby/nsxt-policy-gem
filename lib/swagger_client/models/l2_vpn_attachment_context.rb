...
module SwaggerClient
  class L2VpnAttachmentContext
    ...
    def list_invalid_properties
      ...
      if @tunnel_id.nil?
        invalid_properties.push('invalid value for "tunnel_id", tunnel_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tunnel_id.nil?
      return false if @tunnel_id > 4093
      return false if @tunnel_id < 1
      true
    end
    ...
    def tunnel_id=(tunnel_id)
      if tunnel_id.nil?
        fail ArgumentError, 'tunnel_id cannot be nil'
      end
    ...
    def hash
      [allocate_addresses, resource_type, tunnel_id].hash
    end
