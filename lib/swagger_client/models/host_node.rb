...
module SwaggerClient
  ...
  class HostNode
    ...
    def valid?
      ...
      os_type_validator = EnumAttributeValidator.new('String', ['ESXI', 'RHELKVM', 'UBUNTUKVM', 'HYPERV', 'RHELCONTAINER', 'CENTOSCONTAINER', 'RHELSERVER', 'UBUNTUSERVER', 'CENTOSSERVER', 'CENTOSKVM', 'SLESKVM', 'SLESSERVER'])
    ...
    def os_type=(os_type)
      validator = EnumAttributeValidator.new('String', ['ESXI', 'RHELKVM', 'UBUNTUKVM', 'HYPERV', 'RHELCONTAINER', 'CENTOSCONTAINER', 'RHELSERVER', 'UBUNTUSERVER', 'CENTOSSERVER', 'CENTOSKVM', 'SLESKVM', 'SLESSERVER'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, discovered_ip_addresses, ip_addresses, external_id, fqdn, discovered_node_id, managed_by_server, host_credential, os_version, os_type, maintenance_mode_state].hash
    end
