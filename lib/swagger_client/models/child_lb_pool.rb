...
module SwaggerClient
  ...
  class ChildLBPool
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LBPool')
        self.lb_pool = attributes[:'LBPool']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lb_pool.nil?
        invalid_properties.push('invalid value for "lb_pool", lb_pool cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, lb_pool].hash
    end
