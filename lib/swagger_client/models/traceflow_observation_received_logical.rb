...
module SwaggerClient
  class TraceflowObservationReceivedLogical
    ...
    attr_accessor :src_component_id
    ...
    attr_accessor :src_component_type
    ...
    attr_accessor :src_component_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'src_component_id')
        self.src_component_id = attributes[:'src_component_id']
      end
      ...
      if attributes.has_key?(:'src_component_type')
        self.src_component_type = attributes[:'src_component_type']
      end
      ...
      if attributes.has_key?(:'src_component_name')
        self.src_component_name = attributes[:'src_component_name']
      end
    ...
    def valid?
      ...
      src_component_type_validator = EnumAttributeValidator.new('String', ['PHYSICAL', 'LR', 'LS', 'DFW', 'BRIDGE', 'EDGE_TUNNEL', 'EDGE_HOSTSWITCH', 'FW_BRIDGE', 'LOAD_BALANCER', 'NAT', 'IPSEC', 'SERVICE_INSERTION', 'UNKNOWN'])
      return false unless src_component_type_validator.valid?(@src_component_type)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] src_component_type Object to be assigned
    def src_component_type=(src_component_type)
      validator = EnumAttributeValidator.new('String', ['PHYSICAL', 'LR', 'LS', 'DFW', 'BRIDGE', 'EDGE_TUNNEL', 'EDGE_HOSTSWITCH', 'FW_BRIDGE', 'LOAD_BALANCER', 'NAT', 'IPSEC', 'SERVICE_INSERTION', 'UNKNOWN'])
      unless validator.valid?(src_component_type)
        fail ArgumentError, 'invalid value for "src_component_type", must be one of #{validator.allowable_values}.'
      end
      @src_component_type = src_component_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          src_component_id == o.src_component_id &&
          component_id == o.component_id &&
          lport_id == o.lport_id &&
          src_component_type == o.src_component_type &&
          lport_name == o.lport_name &&
          src_component_name == o.src_component_name &&
          vni == o.vni
    end
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, src_component_id, component_id, lport_id, src_component_type, lport_name, src_component_name, vni].hash
    end
