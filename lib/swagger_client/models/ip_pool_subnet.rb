...
module SwaggerClient
  ...
  class IpPoolSubnet
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dns_nameservers')
        if (value = attributes[:'dns_nameservers']).is_a?(Array)
          self.dns_nameservers = value
        end
      end
      ...
      if attributes.has_key?(:'dns_suffix')
        self.dns_suffix = attributes[:'dns_suffix']
      end
    end
    ...
    def hash
      [_self, _links, _schema, dns_nameservers, cidr, gateway_ip, allocation_ranges, dns_suffix].hash
    end
