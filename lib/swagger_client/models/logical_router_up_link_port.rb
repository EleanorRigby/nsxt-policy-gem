  ...
  class LogicalRouterUpLinkPort
    ...
    def self.swagger_types
      {
        ...
        :'edge_cluster_member_index' => :'Array<Integer>',
        :'urpf_mode' => :'String',
        :'mac_address' => :'String',
        :'mtu' => :'Integer'
      }
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'edge_cluster_member_index')
        if (value = attributes[:'edge_cluster_member_index']).is_a?(Array)
          self.edge_cluster_member_index = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @edge_cluster_member_index.nil?
        invalid_properties.push('invalid value for "edge_cluster_member_index", edge_cluster_member_index cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @edge_cluster_member_index.nil?
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, logical_router_id, service_bindings, subnets, linked_logical_switch_port_id, edge_cluster_member_index, urpf_mode, mac_address, mtu].hash
    end
