...
module SwaggerClient
  ...
  class LbHttpRequestUriArgumentsCondition
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'uri_arguments')
        self.uri_arguments = attributes[:'uri_arguments']
      end
    ...
    def list_invalid_properties
      ...
      if @uri_arguments.nil?
        invalid_properties.push('invalid value for "uri_arguments", uri_arguments cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @uri_arguments.nil?
    ...
    def hash
      [inverse, type, uri_arguments, match_type, case_sensitive].hash
    end
