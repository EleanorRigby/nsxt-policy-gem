...
module SwaggerClient
  ...
  class ChildServiceSegment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ServiceSegment')
        self.service_segment = attributes[:'ServiceSegment']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @service_segment.nil?
        invalid_properties.push('invalid value for "service_segment", service_segment cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @service_segment.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_segment == o.service_segment
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, service_segment].hash
    end
