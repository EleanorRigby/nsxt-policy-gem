...
module SwaggerClient
  ...
  class IPSecVpnRule
    ...
    def self.swagger_types
      {
        ...
        :'sources' => :'Array<IPSecVpnSubnet>',
        :'action' => :'String',
        :'enabled' => :'BOOLEAN',
        :'logged' => :'BOOLEAN',
        :'sequence_number' => :'Integer',
        :'destinations' => :'Array<IPSecVpnSubnet>'
      }
    end
    ...
    def valid?
      ...
      action_validator = EnumAttributeValidator.new('String', ['PROTECT', 'BYPASS'])
    ...
    def action=(action)
      validator = EnumAttributeValidator.new('String', ['PROTECT', 'BYPASS'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, sources, action, enabled, logged, sequence_number, destinations].hash
    end
