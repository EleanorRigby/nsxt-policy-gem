...
module SwaggerClient
  class TransportNodeStatus
    ...
    def hash
      [status, threat_status, agent_status, node_uuid, tunnel_status, mgmt_connection_status, control_connection_status, pnic_status, node_status, node_display_name].hash
    end
