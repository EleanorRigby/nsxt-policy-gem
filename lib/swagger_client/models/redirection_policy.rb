...
module SwaggerClient
  ...
  class RedirectionPolicy
    ...
    def self.swagger_types
      {
        ...
        :'rules' => :'Array<RedirectionRule>',
        :'lock_modified_time' => :'Integer',
        :'sequence_number' => :'Integer',
        :'comments' => :'String',
        :'redirect_to' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'redirect_to')
        if (value = attributes[:'redirect_to']).is_a?(Array)
          self.redirect_to = value
        end
      end
    end
