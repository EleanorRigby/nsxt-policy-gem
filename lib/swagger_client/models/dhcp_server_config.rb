  ...
  class DhcpServerConfig
    ...
    def list_invalid_properties
      ...
      if @server_address.nil?
        invalid_properties.push('invalid value for "server_address", server_address cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @server_address.nil?
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, server_address, edge_cluster_path, lease_time].hash
    end
