...
module SwaggerClient
  ...
  class ChildDhcpRelayConfig
    ...
    attr_accessor :dhcp_relay_config
    ...
    def self.attribute_map
      {
        ...
        :'dhcp_relay_config' => :'DhcpRelayConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DhcpRelayConfig')
        self.dhcp_relay_config = attributes[:'DhcpRelayConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @dhcp_relay_config.nil?
        invalid_properties.push('invalid value for "dhcp_relay_config", dhcp_relay_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dhcp_relay_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dhcp_relay_config == o.dhcp_relay_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, dhcp_relay_config].hash
    end
