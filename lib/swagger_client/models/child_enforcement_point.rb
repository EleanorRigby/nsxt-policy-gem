...
module SwaggerClient
  ...
  class ChildEnforcementPoint
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'EnforcementPoint')
        self.enforcement_point = attributes[:'EnforcementPoint']
      end
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, enforcement_point].hash
    end
