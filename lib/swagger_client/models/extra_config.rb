...
module SwaggerClient
  ...
  class ExtraConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'config_pair')
        self.config_pair = attributes[:'config_pair']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @config_pair.nil?
        invalid_properties.push('invalid value for "config_pair", config_pair cannot be nil.')
      end
    ...
    def valid?
      return false if @config_pair.nil?
      true
    end
