...
module SwaggerClient
  class RuntimeInterfaceStatistics
    ...
    def self.swagger_types
      {
        ...
        :'mac_learning' => :'SIMacLearningCounters',
        :'dropped_by_security_packets' => :'SIPacketsDroppedBySecurity',
    ...
    def hash
      [tx_bytes, rx_packets, tx_packets, rx_bytes, mac_learning, dropped_by_security_packets, last_update_timestamp, interface_index].hash
    end
