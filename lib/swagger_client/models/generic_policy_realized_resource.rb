...
module SwaggerClient
  ...
  class GenericPolicyRealizedResource
    ...
    def self.swagger_types
      {
        ...
        :'extended_attributes' => :'Array<AttributeVal>',
        :'entity_type' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'extended_attributes')
