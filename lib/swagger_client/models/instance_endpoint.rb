...
module SwaggerClient
  ...
  class InstanceEndpoint
    ...
    def self.swagger_types
      {
        ...
        :'link_ids' => :'Array<ResourceReference>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'link_ids')
    ...
    def valid?
      ...
      endpoint_type_validator = EnumAttributeValidator.new('String', ['LOGICAL', 'VIRTUAL'])
    ...
    def endpoint_type=(endpoint_type)
      validator = EnumAttributeValidator.new('String', ['LOGICAL', 'VIRTUAL'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, service_attachments, target_ips, endpoint_type, service_instance_id, link_ids].hash
    end
