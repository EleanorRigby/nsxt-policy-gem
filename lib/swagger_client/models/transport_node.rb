...
module SwaggerClient
  ...
  class TransportNode
    ...
    attr_accessor :node_deployment_info
    ...
    def self.swagger_types
      {
        ...
        :'host_switches' => :'Array<HostSwitch>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'node_deployment_info')
        self.node_deployment_info = attributes[:'node_deployment_info']
      end

      if attributes.has_key?(:'host_switches')
        if (value = attributes[:'host_switches']).is_a?(Array)
          self.host_switches = value
        end
      end
      ...
      if attributes.has_key?(:'is_overridden')
        self.is_overridden = attributes[:'is_overridden']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          node_id == o.node_id &&
          node_deployment_info == o.node_deployment_info &&
          host_switches == o.host_switches &&
          maintenance_mode == o.maintenance_mode &&
          is_overridden == o.is_overridden &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, host_switch_spec, node_id, node_deployment_info, host_switches, maintenance_mode, is_overridden, transport_zone_endpoints].hash
    end
