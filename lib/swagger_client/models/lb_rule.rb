...
module SwaggerClient
  ...
  class LbRule
    ...
    def list_invalid_properties
      ...
      if @match_strategy.nil?
        invalid_properties.push('invalid value for "match_strategy", match_strategy cannot be nil.')
      end
    ...
    def valid?
      ...
      phase_validator = EnumAttributeValidator.new('String', ['HTTP_REQUEST_REWRITE', 'HTTP_FORWARDING', 'HTTP_RESPONSE_REWRITE'])
      return false unless phase_validator.valid?(@phase)
      return false if @actions.nil?
      return false if @match_strategy.nil?
    ...
    def phase=(phase)
      validator = EnumAttributeValidator.new('String', ['HTTP_REQUEST_REWRITE', 'HTTP_FORWARDING', 'HTTP_RESPONSE_REWRITE'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, phase, match_conditions, actions, match_strategy].hash
    end
