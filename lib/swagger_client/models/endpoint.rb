...
module SwaggerClient
  ...
  class Endpoint
    ...
    def list_invalid_properties
      ...
      if !@mac.nil? && @mac !~ Regexp.new(/^(([0-9A-Fa-f]{2}[:]){5}([0-9A-Fa-f]{2}))|(([0-9A-Fa-f]{2}[-]){5}([0-9A-Fa-f]{2}))$/)
        invalid_properties.push('invalid value for "mac", must conform to the pattern /^(([0-9A-Fa-f]{2}[:]){5}([0-9A-Fa-f]{2}))|(([0-9A-Fa-f]{2}[-]){5}([0-9A-Fa-f]{2}))$/.')
      end
    ...
    def valid?
      return false if !@mac.nil? && @mac !~ Regexp.new(/^(([0-9A-Fa-f]{2}[:]){5}([0-9A-Fa-f]{2}))|(([0-9A-Fa-f]{2}[-]){5}([0-9A-Fa-f]{2}))$/)
      true
    end
    ...
    def mac=(mac)
      if !mac.nil? && mac !~ Regexp.new(/^(([0-9A-Fa-f]{2}[:]){5}([0-9A-Fa-f]{2}))|(([0-9A-Fa-f]{2}[-]){5}([0-9A-Fa-f]{2}))$/)
        fail ArgumentError, 'invalid value for "mac", must conform to the pattern /^(([0-9A-Fa-f]{2}[:]){5}([0-9A-Fa-f]{2}))|(([0-9A-Fa-f]{2}[-]){5}([0-9A-Fa-f]{2}))$/.'
      end
    ...
    def hash
      [subnet_mask, mac, default_gateway, ip, device_name, label].hash
    end
