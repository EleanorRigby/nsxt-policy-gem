...
module SwaggerClient
  ...
  class LogicalRouterCentralizedServicePort
    ...
    attr_accessor :enable_netx

    # Reference to the logical switch port to connect to
    attr_accessor :linked_logical_switch_port_id

    # Unicast Reverse Path Forwarding mode
    attr_accessor :urpf_mode

    # Maximum transmission unit specifies the size of the largest packet that network a protocol can transmit. If not specified, the global logical MTU set in the /api/v1/global-configs/RoutingGlobalConfig API will be used. 
    attr_accessor :mtu
    ...
    def self.swagger_types
      {
        ...
        :'service_bindings' => :'Array<ServiceBinding>',
        :'enable_netx' => :'BOOLEAN',
        :'linked_logical_switch_port_id' => :'ResourceReference',
        :'urpf_mode' => :'String',
        :'mtu' => :'Integer',
        :'subnets' => :'Array<IPSubnet>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'service_bindings')
        if (value = attributes[:'service_bindings']).is_a?(Array)
          self.service_bindings = value
        end
      end

      if attributes.has_key?(:'enable_netx')
        self.enable_netx = attributes[:'enable_netx']
      else
        self.enable_netx = false
      end

      if attributes.has_key?(:'linked_logical_switch_port_id')
        self.linked_logical_switch_port_id = attributes[:'linked_logical_switch_port_id']
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['LogicalRouterUpLinkPort', 'LogicalRouterDownLinkPort', 'LogicalRouterLinkPortOnTIER0', 'LogicalRouterLinkPortOnTIER1', 'LogicalRouterLoopbackPort', 'LogicalRouterIPTunnelPort', 'LogicalRouterCentralizedServicePort'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['LogicalRouterUpLinkPort', 'LogicalRouterDownLinkPort', 'LogicalRouterLinkPortOnTIER0', 'LogicalRouterLinkPortOnTIER1', 'LogicalRouterLoopbackPort', 'LogicalRouterIPTunnelPort', 'LogicalRouterCentralizedServicePort'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_bindings == o.service_bindings &&
          enable_netx == o.enable_netx &&
          linked_logical_switch_port_id == o.linked_logical_switch_port_id &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, logical_router_id, service_bindings, enable_netx, linked_logical_switch_port_id, urpf_mode, mtu, subnets].hash
    end
