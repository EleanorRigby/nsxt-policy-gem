...
module SwaggerClient
  ...
  class ChildTier0Interface
    ...
    def self.attribute_map
      {
        ...
        :'tier0_interface' => :'Tier0Interface'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Tier0Interface')
        self.tier0_interface = attributes[:'Tier0Interface']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tier0_interface.nil?
        invalid_properties.push('invalid value for "tier0_interface", tier0_interface cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tier0_interface.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tier0_interface == o.tier0_interface
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, tier0_interface].hash
    end
