...
module SwaggerClient
  ...
  class InstanceRuntime
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'service_vm_id')
        self.service_vm_id = attributes[:'service_vm_id']
      end
      ...
      if attributes.has_key?(:'service_instance_id')
    ...
    def valid?
      ...
      runtime_status_validator = EnumAttributeValidator.new('String', ['IN_SERVICE', 'OUT_OF_SERVICE', 'NEEDS_ATTENTION', 'NOT_AVAILABLE'])
      ...
      deployment_status_validator = EnumAttributeValidator.new('String', ['DEPLOYMENT_IN_PROGRESS', 'DEPLOYMENT_FAILED', 'DEPLOYMENT_SUCCESSFUL', 'UPGRADE_IN_PROGRESS', 'UPGRADE_FAILED', 'UNDEPLOYMENT_IN_PROGRESS', 'UNDEPLOYMENT_FAILED', 'UNDEPLOYMENT_SUCCESSFUL', 'UNKNOWN'])
    ...
    def runtime_status=(runtime_status)
      validator = EnumAttributeValidator.new('String', ['IN_SERVICE', 'OUT_OF_SERVICE', 'NEEDS_ATTENTION', 'NOT_AVAILABLE'])
    ...
    def deployment_status=(deployment_status)
      validator = EnumAttributeValidator.new('String', ['DEPLOYMENT_IN_PROGRESS', 'DEPLOYMENT_FAILED', 'DEPLOYMENT_SUCCESSFUL', 'UPGRADE_IN_PROGRESS', 'UPGRADE_FAILED', 'UNDEPLOYMENT_IN_PROGRESS', 'UNDEPLOYMENT_FAILED', 'UNDEPLOYMENT_SUCCESSFUL', 'UNKNOWN'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, service_vm_id, runtime_status, vm_nic_info, maintenance_mode, error_message, service_instance_id, deployment_status].hash
    end
