...
module SwaggerClient
  ...
  class ChildTlsCertificate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TlsCertificate')
        self.tls_certificate = attributes[:'TlsCertificate']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tls_certificate.nil?
        invalid_properties.push('invalid value for "tls_certificate", tls_certificate cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tls_certificate.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, tls_certificate].hash
    end
