...
module SwaggerClient
  class ComputeManager
    ...
    def list_invalid_properties
      ...
      if @origin_type.nil?
        invalid_properties.push('invalid value for "origin_type", origin_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @origin_type.nil?
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, credential, origin_properties, origin_type, server].hash
    end
