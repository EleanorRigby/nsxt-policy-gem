...
module SwaggerClient
  ...
  class CommunicationInsertParameters
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'anchor_path')
        self.anchor_path = attributes[:'anchor_path']
      end

      if attributes.has_key?(:'operation')
        self.operation = attributes[:'operation']
      else
        self.operation = 'insert_top'
      end
    end
    ...
    def valid?
      operation_validator = EnumAttributeValidator.new('String', ['insert_top', 'insert_bottom', 'insert_after', 'insert_before'])
    ...
    def operation=(operation)
      validator = EnumAttributeValidator.new('String', ['insert_top', 'insert_bottom', 'insert_after', 'insert_before'])
