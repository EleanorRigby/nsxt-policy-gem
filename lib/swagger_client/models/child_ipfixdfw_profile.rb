...
module SwaggerClient
  ...
  class ChildIPFIXDFWProfile
    ...
    attr_accessor :ipfixdfw_profile
    ...
    def self.attribute_map
      {
        ...
        :'ipfixdfw_profile' => :'IPFIXDFWProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IPFIXDFWProfile')
        self.ipfixdfw_profile = attributes[:'IPFIXDFWProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ipfixdfw_profile.nil?
        invalid_properties.push('invalid value for "ipfixdfw_profile", ipfixdfw_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ipfixdfw_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ipfixdfw_profile == o.ipfixdfw_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, ipfixdfw_profile].hash
    end
