...
module SwaggerClient
  ...
  class RouteMapEntry
    ...
    attr_accessor :community_list_matches
    ...
    attr_accessor :prefix_list_matches
    ...
    def self.attribute_map
      {
        :'action' => :'action',
        :'community_list_matches' => :'community_list_matches',
        :'set' => :'set',
    ...
    def self.swagger_types
      {
        :'action' => :'String',
        :'community_list_matches' => :'Array<CommunityMatchCriteria>',
        :'set' => :'RouteMapEntrySet',
        :'prefix_list_matches' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'community_list_matches')
        if (value = attributes[:'community_list_matches']).is_a?(Array)
          self.community_list_matches = value
        end
      end
      ...
      if attributes.has_key?(:'prefix_list_matches')
        if (value = attributes[:'prefix_list_matches']).is_a?(Array)
          self.prefix_list_matches = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          action == o.action &&
          community_list_matches == o.community_list_matches &&
          set == o.set &&
          prefix_list_matches == o.prefix_list_matches
    end
    ...
    def hash
      [action, community_list_matches, set, prefix_list_matches].hash
    end
