...
module SwaggerClient
  ...
  class DirectoryLdapServer
    ...
    # Directory LDAP server certificate thumbprint used in secure LDAPS connection. The thumbprint value will be ignored if provided.
    ...
    def valid?
      ...
      protocol_validator = EnumAttributeValidator.new('String', ['LDAP', 'LDAPS'])
    ...
    def protocol=(protocol)
      validator = EnumAttributeValidator.new('String', ['LDAP', 'LDAPS'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, username, host, protocol, thumbprint, password, domain_name, port].hash
    end
