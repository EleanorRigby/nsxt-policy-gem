...
module SwaggerClient
  ...
  class RelatedAttributeConditionalExpression
    ...
    # Related attribute.
    attr_accessor :related_attribute
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'related_attribute')
        self.related_attribute = attributes[:'related_attribute']
      end
    ...
    def list_invalid_properties
      ...
      if @related_attribute.nil?
        invalid_properties.push('invalid value for "related_attribute", related_attribute cannot be nil.')
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['ValueConstraintExpression', 'RelatedAttributeConditionalExpression', 'EntityInstanceCountConstraintExpression', 'FieldSanityConstraintExpression'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @related_attribute.nil?
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['ValueConstraintExpression', 'RelatedAttributeConditionalExpression', 'EntityInstanceCountConstraintExpression', 'FieldSanityConstraintExpression'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          related_attribute == o.related_attribute &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, related_attribute, condition].hash
    end
