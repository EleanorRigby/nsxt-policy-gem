...
module SwaggerClient
  ...
  class RowListField
    ...
    def list_invalid_properties
      ...
      if @path.to_s.length > 1024
        invalid_properties.push('invalid value for "path", the character length must be smaller than or equal to 1024.')
      end
    ...
    def valid?
      ...
      return false if @path.to_s.length > 1024
      true
    end
    ...
    def path=(path)
      ...
      if path.to_s.length > 1024
        fail ArgumentError, 'invalid value for "path", the character length must be smaller than or equal to 1024.'
      end
