...
module SwaggerClient
  ...
  class IpSecVpnTunnelTrafficStatistics
    ...
    def hash
      [packets_sent_other_error, packets_out, dropped_packets_out, integrity_failures, nomatching_policy_errors, sa_mismatch_errors_in, peer_subnet, replay_errors, bytes_out, packets_received_other_error, dropped_packets_in, encryption_failures, sa_mismatch_errors_out, tunnel_down_reason, local_subnet, bytes_in, decryption_failures, seq_number_overflow_error, packets_in, tunnel_status].hash
    end
