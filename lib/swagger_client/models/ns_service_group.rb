...
module SwaggerClient
  ...
  class NSServiceGroup
    ...
    def valid?
      ...
      service_type_validator = EnumAttributeValidator.new('String', ['ETHER', 'NON_ETHER'])
    ...
    def service_type=(service_type)
      validator = EnumAttributeValidator.new('String', ['ETHER', 'NON_ETHER'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, default_service, service_type, members].hash
    end
