...
module SwaggerClient
  ...
  class ChildLBServerSslProfile
    ...
    attr_accessor :lb_server_ssl_profile
    ...
    def self.attribute_map
      {
        ...
        :'lb_server_ssl_profile' => :'LBServerSslProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LBServerSslProfile')
        self.lb_server_ssl_profile = attributes[:'LBServerSslProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lb_server_ssl_profile.nil?
        invalid_properties.push('invalid value for "lb_server_ssl_profile", lb_server_ssl_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @lb_server_ssl_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          lb_server_ssl_profile == o.lb_server_ssl_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, lb_server_ssl_profile].hash
    end
