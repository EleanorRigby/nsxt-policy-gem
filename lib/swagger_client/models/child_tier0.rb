...
module SwaggerClient
  ...
  class ChildTier0
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Tier0')
        self.tier0 = attributes[:'Tier0']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tier0.nil?
        invalid_properties.push('invalid value for "tier0", tier0 cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, tier0].hash
    end
