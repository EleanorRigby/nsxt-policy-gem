...
module SwaggerClient
  ...
  class ServiceConfig
    ...
    def self.swagger_types
      {
        ...
        :'applied_to' => :'Array<ResourceReference>',
        :'precedence' => :'Integer',
        :'profiles' => :'Array<NSXProfileReference>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'applied_to')
        if (value = attributes[:'applied_to']).is_a?(Array)
          self.applied_to = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if !@precedence.nil? && @precedence > 4294967295
        invalid_properties.push('invalid value for "precedence", must be smaller than or equal to 4294967295.')
      end

      if !@precedence.nil? && @precedence < 0
        invalid_properties.push('invalid value for "precedence", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@precedence.nil? && @precedence > 4294967295
      return false if !@precedence.nil? && @precedence < 0
    ...
    def precedence=(precedence)
      if !precedence.nil? && precedence > 4294967295
        fail ArgumentError, 'invalid value for "precedence", must be smaller than or equal to 4294967295.'
      end

      if !precedence.nil? && precedence < 0
        fail ArgumentError, 'invalid value for "precedence", must be greater than or equal to 0.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, applied_to, precedence, profiles].hash
    end
