...
module SwaggerClient
  ...
  class ChildIpAddressPool
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IpAddressPool')
        self.ip_address_pool = attributes[:'IpAddressPool']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ip_address_pool.nil?
        invalid_properties.push('invalid value for "ip_address_pool", ip_address_pool cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ip_address_pool.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ip_address_pool == o.ip_address_pool
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, ip_address_pool].hash
    end
