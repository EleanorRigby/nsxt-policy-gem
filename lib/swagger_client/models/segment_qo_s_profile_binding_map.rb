...
module SwaggerClient
  ...
  class SegmentQoSProfileBindingMap
    ...
    attr_accessor :qos_profile_path
    ...
    def self.attribute_map
      {
        ...
        :'qos_profile_path' => :'qos_profile_path'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'qos_profile_path')
        self.qos_profile_path = attributes[:'qos_profile_path']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          qos_profile_path == o.qos_profile_path
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, relative_path, children, marked_for_delete, qos_profile_path].hash
    end
