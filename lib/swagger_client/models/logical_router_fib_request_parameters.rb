...
module SwaggerClient
  # Filter parameters for filtering routes from FIB depending on provided properties. 
  class LogicalRouterFIBRequestParameters
    ...
    # CIDR network address to filter the the FIB table.
    ...
    def hash
      [source, transport_node_id, network_prefix].hash
    end
