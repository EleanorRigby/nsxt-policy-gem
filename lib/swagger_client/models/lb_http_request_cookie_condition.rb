...
module SwaggerClient
  ...
  class LbHttpRequestCookieCondition
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cookie_value')
        self.cookie_value = attributes[:'cookie_value']
      end
    ...
    def list_invalid_properties
      ...
      if @cookie_value.nil?
        invalid_properties.push('invalid value for "cookie_value", cookie_value cannot be nil.')
      end
    ...
    def hash
      [inverse, type, match_type, cookie_name, cookie_value, case_sensitive].hash
    end
