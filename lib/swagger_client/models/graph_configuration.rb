...
module SwaggerClient
  ...
  class GraphConfiguration
    ...
    def self.swagger_types
      {
        ...
        :'legend' => :'Legend',
        :'graphs' => :'Array<GraphDefinition>',
        :'axes' => :'Axes',
        :'navigation' => :'String',
        :'sub_type' => :'String',
        :'display_x_value' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'graphs')
        if (value = attributes[:'graphs']).is_a?(Array)
          self.graphs = value
        end
      end
      ...
      if attributes.has_key?(:'sub_type')
        ...
        self.sub_type = 'BAR_GRAPH'
      end

      if attributes.has_key?(:'display_x_value')
        self.display_x_value = attributes[:'display_x_value']
      else
        self.display_x_value = false
      end
    end
    ...
    def list_invalid_properties
      ...
      if @graphs.nil?
        invalid_properties.push('invalid value for "graphs", graphs cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @graphs.nil?
      sub_type_validator = EnumAttributeValidator.new('String', ['LINE_GRAPH', 'BAR_GRAPH', 'STACKED_BAR_GRAPH'])
    ...
    def sub_type=(sub_type)
      validator = EnumAttributeValidator.new('String', ['LINE_GRAPH', 'BAR_GRAPH', 'STACKED_BAR_GRAPH'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sub_type == o.sub_type &&
          display_x_value == o.display_x_value
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, datasources, weight, icons, shared, footer, drilldown_id, is_drilldown, legend, graphs, axes, navigation, sub_type, display_x_value].hash
    end
