...
module SwaggerClient
  ...
  class GridConfiguration
    ...
    def self.swagger_types
      {
        ...
        :'page_size' => :'Integer',
        :'span' => :'Integer',
        :'row_list_fields' => :'Array<RowListField>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'row_list_fields')
        if (value = attributes[:'row_list_fields']).is_a?(Array)
          self.row_list_fields = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @row_list_fields.nil?
        invalid_properties.push('invalid value for "row_list_fields", row_list_fields cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @row_list_fields.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          span == o.span &&
          row_list_fields == o.row_list_fields &&
          columns == o.columns
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, datasources, weight, icons, shared, footer, drilldown_id, is_drilldown, legend, page_size, span, row_list_fields, columns].hash
    end
