...
module SwaggerClient
  ...
  class BridgeEndpoint
    ...
    # This field will not be used if an edge cluster is being used for the bridge endpoint 
    attr_accessor :bridge_cluster_id

    # This field will not be used if a bridge cluster is being used for the bridge endpoint 
    attr_accessor :vlan_transport_zone_id

    # This field will not be used if a bridge cluster is being used for the bridge endpoint 
    attr_accessor :bridge_endpoint_profile_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ha_enable')
        self.ha_enable = attributes[:'ha_enable']
      else
        self.ha_enable = true
      end

      if attributes.has_key?(:'bridge_cluster_id')
        self.bridge_cluster_id = attributes[:'bridge_cluster_id']
      end

      if attributes.has_key?(:'vlan_transport_zone_id')
        self.vlan_transport_zone_id = attributes[:'vlan_transport_zone_id']
      end

      if attributes.has_key?(:'bridge_endpoint_profile_id')
        self.bridge_endpoint_profile_id = attributes[:'bridge_endpoint_profile_id']
      end
    ...
    def list_invalid_properties
      ...
      if !@bridge_cluster_id.nil? && @bridge_cluster_id.to_s.length > 36
        invalid_properties.push('invalid value for "bridge_cluster_id", the character length must be smaller than or equal to 36.')
      end

      if @vlan.nil?
        invalid_properties.push('invalid value for "vlan", vlan cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if !@bridge_cluster_id.nil? && @bridge_cluster_id.to_s.length > 36
      return false if @vlan.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] bridge_cluster_id Value to be assigned
    def bridge_cluster_id=(bridge_cluster_id)
      if !bridge_cluster_id.nil? && bridge_cluster_id.to_s.length > 36
        fail ArgumentError, 'invalid value for "bridge_cluster_id", the character length must be smaller than or equal to 36.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ha_enable == o.ha_enable &&
          bridge_cluster_id == o.bridge_cluster_id &&
          vlan_transport_zone_id == o.vlan_transport_zone_id &&
          bridge_endpoint_profile_id == o.bridge_endpoint_profile_id &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, ha_enable, bridge_cluster_id, vlan_transport_zone_id, bridge_endpoint_profile_id, uplink_teaming_policy_name, vlan].hash
    end
