...
module SwaggerClient
  ...
  class ChildL3Vpn
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'L3Vpn')
        self.l3_vpn = attributes[:'L3Vpn']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @l3_vpn.nil?
        invalid_properties.push('invalid value for "l3_vpn", l3_vpn cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, l3_vpn].hash
    end
