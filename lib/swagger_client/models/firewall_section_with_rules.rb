...
module SwaggerClient
  class FirewallSectionWithRules
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'section_type')
      ...
      if attributes.has_key?(:'enforced_on')
        self.enforced_on = attributes[:'enforced_on']
      end
      ...
      if attributes.has_key?(:'autoplumbed')
        self.autoplumbed = attributes[:'autoplumbed']
      else
        self.autoplumbed = false
      end
    ...
    def valid?
      ...
      section_type_validator = EnumAttributeValidator.new('String', ['LAYER2', 'LAYER3', 'L3REDIRECT'])
    ...
    def section_type=(section_type)
      validator = EnumAttributeValidator.new('String', ['LAYER2', 'LAYER3', 'L3REDIRECT'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, stateful, is_default, applied_tos, rule_count, section_type, priority, enforced_on, locked, tcp_strict, lock_modified_by, lock_modified_time, comments, autoplumbed, rules].hash
    end
