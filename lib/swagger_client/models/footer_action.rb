...
module SwaggerClient
  ...
  class FooterAction
    ...
    attr_accessor :dock_to_container_footer
    ...
    def self.swagger_types
      {
        :'url' => :'String',
        :'dock_to_container_footer' => :'BOOLEAN',
        :'label' => :'Label'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dock_to_container_footer')
        self.dock_to_container_footer = attributes[:'dock_to_container_footer']
      else
        self.dock_to_container_footer = true
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          url == o.url &&
          dock_to_container_footer == o.dock_to_container_footer &&
          label == o.label
    end
    ...
    def hash
      [url, dock_to_container_footer, label].hash
    end
