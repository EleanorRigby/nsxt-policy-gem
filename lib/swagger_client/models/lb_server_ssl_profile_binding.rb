...
module SwaggerClient
  ...
  class LBServerSslProfileBinding
    ...
    attr_accessor :server_auth_ca_paths
    ...
    attr_accessor :server_auth_crl_paths
    ...
    def self.attribute_map
      {
        :'server_auth_ca_paths' => :'server_auth_ca_paths',
        :'client_certificate_path' => :'client_certificate_path',
        :'server_auth' => :'server_auth',
        :'certificate_chain_depth' => :'certificate_chain_depth',
        :'server_auth_crl_paths' => :'server_auth_crl_paths',
    ...
    def self.swagger_types
      {
        :'server_auth_ca_paths' => :'Array<String>',
        :'client_certificate_path' => :'String',
        :'server_auth' => :'String',
        :'certificate_chain_depth' => :'Integer',
        :'server_auth_crl_paths' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'server_auth_ca_paths')
        if (value = attributes[:'server_auth_ca_paths']).is_a?(Array)
          self.server_auth_ca_paths = value
        end
      end

      if attributes.has_key?(:'client_certificate_path')
        self.client_certificate_path = attributes[:'client_certificate_path']
      end

      if attributes.has_key?(:'server_auth')
        self.server_auth = attributes[:'server_auth']
      else
        self.server_auth = 'AUTO_APPLY'
      end
      ...
      if attributes.has_key?(:'server_auth_crl_paths')
        if (value = attributes[:'server_auth_crl_paths']).is_a?(Array)
          self.server_auth_crl_paths = value
        end
      end
    ...
    def valid?
      server_auth_validator = EnumAttributeValidator.new('String', ['REQUIRED', 'IGNORE', 'AUTO_APPLY'])
    ...
    def server_auth=(server_auth)
      validator = EnumAttributeValidator.new('String', ['REQUIRED', 'IGNORE', 'AUTO_APPLY'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          server_auth_ca_paths == o.server_auth_ca_paths &&
          client_certificate_path == o.client_certificate_path &&
          server_auth == o.server_auth &&
          certificate_chain_depth == o.certificate_chain_depth &&
          server_auth_crl_paths == o.server_auth_crl_paths &&
    ...
    def hash
      [server_auth_ca_paths, client_certificate_path, server_auth, certificate_chain_depth, server_auth_crl_paths, ssl_profile_path].hash
    end
