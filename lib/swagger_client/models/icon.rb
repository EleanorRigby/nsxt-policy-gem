...
module SwaggerClient
  ...
  class Icon
    ...
    def valid?
      placement_validator = EnumAttributeValidator.new('String', ['PRE', 'POST'])
      return false unless placement_validator.valid?(@placement)
      type_validator = EnumAttributeValidator.new('String', ['ERROR', 'WARNING', 'INFO', 'INPROGRESS', 'SUCCESS', 'DETAIL', 'NOT_AVAILABLE', 'SECURITY', 'NETWORKING', 'LOAD_BALANCER', 'VPN', 'DOMAIN', 'GROUP', 'DISTRIBUTED_FIREWALL', 'NETWORKING_TIER0', 'NETWORKING_TIER1', 'SEGMENT', 'SYSTEM', 'SYSTEM_FABRIC', 'SYSTEM_BACKUPRESTORE', 'INVENTORY_GROUPS', 'SECURITY_DFW'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['ERROR', 'WARNING', 'INFO', 'INPROGRESS', 'SUCCESS', 'DETAIL', 'NOT_AVAILABLE', 'SECURITY', 'NETWORKING', 'LOAD_BALANCER', 'VPN', 'DOMAIN', 'GROUP', 'DISTRIBUTED_FIREWALL', 'NETWORKING_TIER0', 'NETWORKING_TIER1', 'SEGMENT', 'SYSTEM', 'SYSTEM_FABRIC', 'SYSTEM_BACKUPRESTORE', 'INVENTORY_GROUPS', 'SECURITY_DFW'])
