...
module SwaggerClient
  ...
  class ChildTlsCrl
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TlsCrl')
        self.tls_crl = attributes[:'TlsCrl']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tls_crl.nil?
        invalid_properties.push('invalid value for "tls_crl", tls_crl cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, marked_for_delete, tls_crl].hash
    end
