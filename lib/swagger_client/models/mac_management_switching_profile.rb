...
module SwaggerClient
  class MacManagementSwitchingProfile
    ...
    attr_accessor :mac_change_allowed
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mac_change_allowed')
        self.mac_change_allowed = attributes[:'mac_change_allowed']
      else
        self.mac_change_allowed = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mac_change_allowed == o.mac_change_allowed
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, required_capabilities, mac_learning, mac_change_allowed].hash
    end
